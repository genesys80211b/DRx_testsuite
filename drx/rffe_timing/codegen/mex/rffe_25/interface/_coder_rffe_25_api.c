...
void rffe_25_api(const mxArray * const prhs[4], const mxArray *plhs[1])
{
  creal_T df[1408];
  boolean_T ft;
  real_T cas;
  ...
  rffe_25(&st, df, ft, cas, cau, dfr);

  /* Marshall function outputs */
  plhs[0] = c_emlrt_marshallOut(&st, dfr);
}

/* End of code generation (_coder_rffe_25_api.c) */
