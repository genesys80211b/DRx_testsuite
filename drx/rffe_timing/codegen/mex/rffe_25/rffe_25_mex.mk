...
MAKEFILE = rffe_25_mex.mk

include rffe_25_mex.mki
...
MEX_FILE_NAME_WO_EXT = rffe_25_mex
...
SYS_INCLUDE += -I "$(START_DIR)/codegen/mex/rffe_25"
...
%.$(OBJEXT) : $(START_DIR)/codegen/mex/rffe_25/%.c
	$(CC) $(CCFLAGS) "$<"
...
%.$(OBJEXT) : $(START_DIR)/codegen/mex/rffe_25/%.cu
	$(CC) $(CCFLAGS) "$<"
...
%.$(OBJEXT) : $(START_DIR)/codegen/mex/rffe_25/%.cpp
	$(CXX) $(CPPFLAGS) "$<"
