START_DIR = /usr/local/MATLAB/V40_demo/drx/rffe_timing

MATLAB_ROOT = /usr/local/MATLAB/R2015b
MAKEFILE = rffe_100_mex.mk

include rffe_100_mex.mki
...
SRC_FILES =  \
	...
	_coder_rffe_100_api.c \
	_coder_rffe_100_mex.c

MEX_FILE_NAME_WO_EXT = rffe_100_mex
...
SYS_INCLUDE += -I "$(START_DIR)/codegen/mex/rffe_100"
...
%.$(OBJEXT) : $(START_DIR)/codegen/mex/rffe_100/%.c
	$(CC) $(CCFLAGS) "$<"
...
%.$(OBJEXT) : $(START_DIR)/codegen/mex/rffe_100/%.cu
	$(CC) $(CCFLAGS) "$<"
...
%.$(OBJEXT) : $(START_DIR)/codegen/mex/rffe_100/%.cpp
	$(CXX) $(CPPFLAGS) "$<"
