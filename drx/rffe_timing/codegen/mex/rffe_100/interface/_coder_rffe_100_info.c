 ...
 *
 * _coder_rffe_100_info.c
 *
 * Code generation for function '_coder_rffe_100_info'
 *
 */
...
#include "rffe_100.h"
#include "_coder_rffe_100_info.h"
...
static void b_info_helper(const mxArray **info)
{
  ...
  emlrtAddField(*info, emlrt_marshallOut(
    "[IXC]/usr/local/MATLAB/R2015b/toolbox/shared/system/coder/+matlab/+system/+coder/SystemProp.p"),
                "context", 64);
  emlrtAddField(*info, emlrt_marshallOut("matlab.system.pvParse"), "name", 64);
  ...
  emlrtAddField(*info, emlrt_marshallOut(
    "[IXE]/usr/local/MATLAB/R2015b/toolbox/matlab/system/+matlab/+system/pvParse.p"),
                "resolved", 64);
  emlrtAddField(*info, b_emlrt_marshallOut(1431666890U), "fileTimeLo", 64);
  ...
  emlrtAddField(*info, emlrt_marshallOut(
    "[ILXE]/usr/local/MATLAB/R2015b/toolbox/eml/lib/matlab/elmat/repmat.m"),
                "resolved", 65);
  emlrtAddField(*info, b_emlrt_marshallOut(1427229244U), "fileTimeLo", 65);
  ...
  emlrtAddField(*info, emlrt_marshallOut(
    "[ILXE]/usr/local/MATLAB/R2015b/toolbox/eml/eml/+coder/+internal/+scalar/floor.m"),
                "resolved", 69);
  emlrtAddField(*info, b_emlrt_marshallOut(1415929514U), "fileTimeLo", 69);
  ...
  emlrtAddField(*info, emlrt_marshallOut(
    "[ILXE]/usr/local/MATLAB/R2015b/toolbox/eml/lib/matlab/elfun/floor.m"),
                "context", 70);
  emlrtAddField(*info, emlrt_marshallOut(
    "coder.internal.applyScalarFunctionInPlace"), "name", 70);
  ...
  emlrtAddField(*info, emlrt_marshallOut(
    "[ILXE]/usr/local/MATLAB/R2015b/toolbox/eml/eml/+coder/+internal/applyScalarFunctionInPlace.m"),
                "resolved", 70);
  emlrtAddField(*info, b_emlrt_marshallOut(1422905800U), "fileTimeLo", 70);
  ...
  emlrtAddField(*info, emlrt_marshallOut(
    "[ILXE]/usr/local/MATLAB/R2015b/toolbox/eml/eml/+coder/+internal/assertValidSizeArg.m"),
                "resolved", 72);
  emlrtAddField(*info, b_emlrt_marshallOut(1427227022U), "fileTimeLo", 72);
  ...
  emlrtAddField(*info, emlrt_marshallOut(
    "[ILXE]/usr/local/MATLAB/R2015b/toolbox/shared/coder/coder/+coder/+internal/indexIntRelop.m"),
                "resolved", 78);
  emlrtAddField(*info, b_emlrt_marshallOut(1415929546U), "fileTimeLo", 78);
  ...
  emlrtAddField(*info, emlrt_marshallOut(
    "[ILXE]/usr/local/MATLAB/R2015b/toolbox/shared/coder/coder/+coder/+internal/indexIntRelop.m!is_signed_indexIntClass"),
                "context", 80);
  emlrtAddField(*info, emlrt_marshallOut("intmin"), "name", 80);
  ...
  emlrtAddField(*info, emlrt_marshallOut(
    "[ILXE]/usr/local/MATLAB/R2015b/toolbox/eml/eml/+coder/+internal/assertValidSizeArg.m"),
                "context", 81);
  emlrtAddField(*info, emlrt_marshallOut("intmin"), "name", 81);
  ...
  emlrtAddField(*info, emlrt_marshallOut(
    "[ILXE]/usr/local/MATLAB/R2015b/toolbox/eml/lib/matlab/datafun/max.m"),
                "resolved", 83);
  emlrtAddField(*info, b_emlrt_marshallOut(1415929526U), "fileTimeLo", 83);
  ...
  emlrtAddField(*info, emlrt_marshallOut(
    "[ILXE]/usr/local/MATLAB/R2015b/toolbox/eml/lib/matlab/datafun/max.m"),
                "context", 84);
  emlrtAddField(*info, emlrt_marshallOut("coder.internal.minOrMax"), "name", 84);
  ...
  emlrtAddField(*info, emlrt_marshallOut(
    "[ILXE]/usr/local/MATLAB/R2015b/toolbox/eml/eml/+coder/+internal/minOrMax.m"),
                "resolved", 84);
  emlrtAddField(*info, b_emlrt_marshallOut(1426794442U), "fileTimeLo", 84);
  ...
  emlrtAddField(*info, emlrt_marshallOut(
    "[ILXE]/usr/local/MATLAB/R2015b/toolbox/eml/eml/+coder/+internal/scalarEg.m"),
                "resolved", 85);
  emlrtAddField(*info, b_emlrt_marshallOut(1415929516U), "fileTimeLo", 85);
  ...
  emlrtAddField(*info, emlrt_marshallOut(
    "[ILXE]/usr/local/MATLAB/R2015b/toolbox/eml/eml/+coder/+internal/scalarEg.m!firstfi"),
                "context", 86);
  emlrtAddField(*info, emlrt_marshallOut("isfi"), "name", 86);
  emlrtAddField(*info, emlrt_marshallOut("coder.internal.indexInt"),
                "dominantType", 86);
  emlrtAddField(*info, emlrt_marshallOut(
    "[ILXE]/usr/local/MATLAB/R2015b/toolbox/eml/lib/fixedpoint/isfi.m"),
                "resolved", 86);
  emlrtAddField(*info, b_emlrt_marshallOut(1415929524U), "fileTimeLo", 86);
  ...
  emlrtAddField(*info, emlrt_marshallOut(
    "[ILXE]/usr/local/MATLAB/R2015b/toolbox/eml/eml/+coder/+internal/scalexpAlloc.m"),
                "resolved", 87);
  emlrtAddField(*info, b_emlrt_marshallOut(1415929516U), "fileTimeLo", 87);
  ...
  emlrtAddField(*info, emlrt_marshallOut(
    "[ILXE]/usr/local/MATLAB/R2015b/toolbox/eml/eml/+coder/+internal/scalexpAllocNoCheck.m"),
                "resolved", 88);
  emlrtAddField(*info, b_emlrt_marshallOut(1410458690U), "fileTimeLo", 88);
  ...
  emlrtAddField(*info, emlrt_marshallOut(
    "[ILXE]/usr/local/MATLAB/R2015b/toolbox/eml/eml/+coder/+internal/scalarEg.m"),
                "resolved", 89);
  emlrtAddField(*info, b_emlrt_marshallOut(1415929516U), "fileTimeLo", 89);
  ...
  emlrtAddField(*info, emlrt_marshallOut(
    "[ILXE]/usr/local/MATLAB/R2015b/toolbox/eml/lib/matlab/eml/eml_int_forloop_overflow_check.m"),
                "resolved", 91);
  emlrtAddField(*info, b_emlrt_marshallOut(1415929534U), "fileTimeLo", 91);
  ...
  emlrtAddField(*info, emlrt_marshallOut(
    "[IXC]/usr/local/MATLAB/R2015b/toolbox/shared/system/coder/+matlab/+system/+coder/SystemProp.p"),
                "context", 92);
  emlrtAddField(*info, emlrt_marshallOut("strcmpi"), "name", 92);
  ...
  emlrtAddField(*info, emlrt_marshallOut(
    "[ILXE]/usr/local/MATLAB/R2015b/toolbox/eml/lib/matlab/strfun/strcmpi.m"),
                "resolved", 92);
  emlrtAddField(*info, b_emlrt_marshallOut(1428518594U), "fileTimeLo", 92);
  ...
  emlrtAddField(*info, emlrt_marshallOut(
    "[ILXE]/usr/local/MATLAB/R2015b/toolbox/eml/lib/matlab/strfun/strcmpi.m"),
                "context", 93);
  emlrtAddField(*info, emlrt_marshallOut("coder.internal.narginchk"), "name", 93);
  emlrtAddField(*info, emlrt_marshallOut(""), "dominantType", 93);
  emlrtAddField(*info, emlrt_marshallOut(
    "[ILXE]/usr/local/MATLAB/R2015b/toolbox/shared/coder/coder/+coder/+internal/narginchk.m"),
                "resolved", 93);
  emlrtAddField(*info, b_emlrt_marshallOut(1363732558U), "fileTimeLo", 93);
  ...
  emlrtAddField(*info, emlrt_marshallOut(
    "[ILXE]/usr/local/MATLAB/R2015b/toolbox/eml/lib/matlab/strfun/strcmpi.m"),
                "context", 94);
  emlrtAddField(*info, emlrt_marshallOut("coder.internal.strcmp"), "name", 94);
  ...
  emlrtAddField(*info, emlrt_marshallOut(
    "[ILXE]/usr/local/MATLAB/R2015b/toolbox/eml/eml/+coder/+internal/strcmp.m"),
                "resolved", 94);
  emlrtAddField(*info, b_emlrt_marshallOut(1428952968U), "fileTimeLo", 94);
  ...
  emlrtAddField(*info, emlrt_marshallOut(
    "[ILXE]/usr/local/MATLAB/R2015b/toolbox/eml/eml/+coder/+internal/strcmp.m"),
                "context", 95);
  emlrtAddField(*info, emlrt_marshallOut("coder.internal.narginchk"), "name", 95);
  emlrtAddField(*info, emlrt_marshallOut(""), "dominantType", 95);
  emlrtAddField(*info, emlrt_marshallOut(
    "[ILXE]/usr/local/MATLAB/R2015b/toolbox/shared/coder/coder/+coder/+internal/narginchk.m"),
                "resolved", 95);
  emlrtAddField(*info, b_emlrt_marshallOut(1363732558U), "fileTimeLo", 95);
  ...
  emlrtAddField(*info, emlrt_marshallOut(
    "[ILXE]/usr/local/MATLAB/R2015b/toolbox/eml/eml/+coder/+internal/scalarEg.m"),
                "resolved", 97);
  emlrtAddField(*info, b_emlrt_marshallOut(1415929516U), "fileTimeLo", 97);
  ...
  emlrtAddField(*info, emlrt_marshallOut(
    "[ILXE]/usr/local/MATLAB/R2015b/toolbox/eml/eml/+coder/+internal/scalexpAlloc.m"),
                "resolved", 98);
  emlrtAddField(*info, b_emlrt_marshallOut(1415929516U), "fileTimeLo", 98);
  ...
  emlrtAddField(*info, emlrt_marshallOut(
    "[ILXE]/usr/local/MATLAB/R2015b/toolbox/eml/eml/+coder/+internal/scalarEg.m"),
                "resolved", 99);
  emlrtAddField(*info, b_emlrt_marshallOut(1415929516U), "fileTimeLo", 99);
  ...
  emlrtAddField(*info, emlrt_marshallOut(
    "[ILXE]/usr/local/MATLAB/R2015b/toolbox/eml/lib/matlab/eml/eml_int_forloop_overflow_check.m"),
                "resolved", 101);
  emlrtAddField(*info, b_emlrt_marshallOut(1415929534U), "fileTimeLo", 101);
  ...
  emlrtAddField(*info, emlrt_marshallOut(
    "[ILXE]/usr/local/MATLAB/R2015b/toolbox/eml/eml/+coder/+internal/assertSupportedString.m"),
                "resolved", 102);
  emlrtAddField(*info, b_emlrt_marshallOut(1428518234U), "fileTimeLo", 102);
  ...
  emlrtAddField(*info, emlrt_marshallOut(
    "[ILXE]/usr/local/MATLAB/R2015b/toolbox/eml/eml/+coder/+internal/assertSupportedString.m!inrange"),
                "context", 104);
  emlrtAddField(*info, emlrt_marshallOut("coder.internal.charmax"), "name", 104);
  ...
  emlrtAddField(*info, emlrt_marshallOut(
    "[ILXE]/usr/local/MATLAB/R2015b/toolbox/eml/eml/+coder/+internal/charmax.m"),
                "resolved", 104);
  emlrtAddField(*info, b_emlrt_marshallOut(1428518376U), "fileTimeLo", 104);
  ...
  emlrtAddField(*info, emlrt_marshallOut(
    "[ILXE]/usr/local/MATLAB/R2015b/toolbox/eml/eml/+coder/+internal/assertSupportedString.m"),
                "context", 106);
  emlrtAddField(*info, emlrt_marshallOut("coder.internal.charmax"), "name", 106);
  emlrtAddField(*info, emlrt_marshallOut(""), "dominantType", 106);
  emlrtAddField(*info, emlrt_marshallOut(
    "[ILXE]/usr/local/MATLAB/R2015b/toolbox/eml/eml/+coder/+internal/charmax.m"),
                "resolved", 106);
  emlrtAddField(*info, b_emlrt_marshallOut(1428518376U), "fileTimeLo", 106);
  ...
  emlrtAddField(*info, emlrt_marshallOut(
    "[ILXE]/usr/local/MATLAB/R2015b/toolbox/eml/eml/+coder/+internal/strcmp.m!charcmp"),
                "context", 107);
  emlrtAddField(*info, emlrt_marshallOut("lower"), "name", 107);
  ...
  emlrtAddField(*info, emlrt_marshallOut(
    "[ILXE]/usr/local/MATLAB/R2015b/toolbox/eml/lib/matlab/strfun/lower.m"),
                "resolved", 107);
  emlrtAddField(*info, b_emlrt_marshallOut(1415929544U), "fileTimeLo", 107);
  ...
  emlrtAddField(*info, emlrt_marshallOut(
    "[ILXE]/usr/local/MATLAB/R2015b/toolbox/eml/lib/matlab/strfun/lower.m"),
                "context", 108);
  emlrtAddField(*info, emlrt_marshallOut("eml_string_transform"), "name", 108);
  ...
  emlrtAddField(*info, emlrt_marshallOut(
    "[ILXE]/usr/local/MATLAB/R2015b/toolbox/eml/lib/matlab/strfun/eml_string_transform.m"),
                "resolved", 108);
  emlrtAddField(*info, b_emlrt_marshallOut(1428518274U), "fileTimeLo", 108);
  ...
  emlrtAddField(*info, emlrt_marshallOut(
    "[ILXE]/usr/local/MATLAB/R2015b/toolbox/eml/eml/+coder/+internal/assertSupportedString.m"),
                "resolved", 109);
  emlrtAddField(*info, b_emlrt_marshallOut(1428518234U), "fileTimeLo", 109);
  ...
  emlrtAddField(*info, emlrt_marshallOut(
    "[ILXE]/usr/local/MATLAB/R2015b/toolbox/eml/lib/matlab/strfun/eml_string_transform.m"),
                "context", 110);
  emlrtAddField(*info, emlrt_marshallOut("coder.internal.charmax"), "name", 110);
  emlrtAddField(*info, emlrt_marshallOut(""), "dominantType", 110);
  emlrtAddField(*info, emlrt_marshallOut(
    "[ILXE]/usr/local/MATLAB/R2015b/toolbox/eml/eml/+coder/+internal/charmax.m"),
                "resolved", 110);
  emlrtAddField(*info, b_emlrt_marshallOut(1428518376U), "fileTimeLo", 110);
  ...
  emlrtAddField(*info, emlrt_marshallOut(
    "[ILXE]/usr/local/MATLAB/R2015b/toolbox/eml/lib/matlab/ops/colon.m"),
                "resolved", 111);
  emlrtAddField(*info, b_emlrt_marshallOut(1415929538U), "fileTimeLo", 111);
  ...
  emlrtAddField(*info, emlrt_marshallOut(
    "[ILXE]/usr/local/MATLAB/R2015b/toolbox/eml/lib/matlab/ops/colon.m"),
                "resolved", 112);
  emlrtAddField(*info, b_emlrt_marshallOut(1415929538U), "fileTimeLo", 112);
  ...
  emlrtAddField(*info, emlrt_marshallOut(
    "[ILXE]/usr/local/MATLAB/R2015b/toolbox/eml/lib/matlab/elfun/floor.m"),
                "resolved", 115);
  emlrtAddField(*info, b_emlrt_marshallOut(1419335428U), "fileTimeLo", 115);
  ...
  emlrtAddField(*info, emlrt_marshallOut(
    "[ILXE]/usr/local/MATLAB/R2015b/toolbox/eml/lib/matlab/elmat/intmin.m"),
                "resolved", 116);
  emlrtAddField(*info, b_emlrt_marshallOut(1415929532U), "fileTimeLo", 116);
  ...
  emlrtAddField(*info, emlrt_marshallOut(
    "[ILXE]/usr/local/MATLAB/R2015b/toolbox/eml/eml/+coder/+internal/isaUint.m"),
                "resolved", 120);
  emlrtAddField(*info, b_emlrt_marshallOut(1376002262U), "fileTimeLo", 120);
  ...
  emlrtAddField(*info, emlrt_marshallOut(
    "[ILXE]/usr/local/MATLAB/R2015b/toolbox/eml/lib/matlab/elmat/intmax.m"),
                "resolved", 122);
  emlrtAddField(*info, b_emlrt_marshallOut(1415929532U), "fileTimeLo", 122);
  ...
  emlrtAddField(*info, emlrt_marshallOut(
    "[ILXE]/usr/local/MATLAB/R2015b/toolbox/eml/lib/matlab/ops/colon.m!integer_colon_length_nonnegd"),
                "context", 123);
  emlrtAddField(*info, emlrt_marshallOut("coder.internal.isaUint"), "name", 123);
  emlrtAddField(*info, emlrt_marshallOut("int8"), "dominantType", 123);
  emlrtAddField(*info, emlrt_marshallOut(
    "[ILXE]/usr/local/MATLAB/R2015b/toolbox/eml/eml/+coder/+internal/isaUint.m"),
                "resolved", 123);
  emlrtAddField(*info, b_emlrt_marshallOut(1376002262U), "fileTimeLo", 123);
  ...
  emlrtAddField(*info, emlrt_marshallOut(
    "[ILXE]/usr/local/MATLAB/R2015b/toolbox/eml/lib/matlab/eml/eml_int_forloop_overflow_check.m"),
                "resolved", 125);
  emlrtAddField(*info, b_emlrt_marshallOut(1415929534U), "fileTimeLo", 125);
  ...
  emlrtAddField(*info, emlrt_marshallOut(
    "[ILXE]/usr/local/MATLAB/R2015b/toolbox/eml/lib/matlab/strfun/eml_string_transform.m"),
                "context", 126);
  emlrtAddField(*info, emlrt_marshallOut("char"), "name", 126);
  ...
  emlrtAddField(*info, emlrt_marshallOut(
    "[ILXE]/usr/local/MATLAB/R2015b/toolbox/eml/lib/matlab/strfun/char.m"),
                "resolved", 126);
  emlrtAddField(*info, b_emlrt_marshallOut(1415929544U), "fileTimeLo", 126);
  ...
  emlrtAddField(*info, emlrt_marshallOut(
    "[IXC]/usr/local/MATLAB/R2015b/toolbox/comm/comm/+comm/+internal/CoarseFrequencyEstimatorBase.m"),
                "context", 127);
  emlrtAddField(*info, emlrt_marshallOut("validateattributes"), "name", 127);
  emlrtAddField(*info, emlrt_marshallOut("cell"), "dominantType", 127);
  emlrtAddField(*info, emlrt_marshallOut(
    "[ILXE]/usr/local/MATLAB/R2015b/toolbox/eml/lib/matlab/lang/validateattributes.m"),
                "resolved", 127);
  emlrtAddField(*info, b_emlrt_marshallOut(1421766848U), "fileTimeLo", 127);
...
static void c_info_helper(const mxArray **info)
{
  ...
  emlrtAddField(*info, emlrt_marshallOut(
    "[IXC]/usr/local/MATLAB/R2015b/toolbox/comm/comm/+comm/PSKCoarseFrequencyEstimator.m"),
                "context", 128);
  emlrtAddField(*info, emlrt_marshallOut("validateattributes"), "name", 128);
  emlrtAddField(*info, emlrt_marshallOut("cell"), "dominantType", 128);
  emlrtAddField(*info, emlrt_marshallOut(
    "[ILXE]/usr/local/MATLAB/R2015b/toolbox/eml/lib/matlab/lang/validateattributes.m"),
                "resolved", 128);
  emlrtAddField(*info, b_emlrt_marshallOut(1421766848U), "fileTimeLo", 128);
  ...
  emlrtAddField(*info, emlrt_marshallOut(
    "[IXC]/usr/local/MATLAB/R2015b/toolbox/comm/comm/+comm/PSKCoarseFrequencyEstimator.m"),
                "context", 129);
  emlrtAddField(*info, emlrt_marshallOut("log2"), "name", 129);
  ...
  emlrtAddField(*info, emlrt_marshallOut(
    "[ILXE]/usr/local/MATLAB/R2015b/toolbox/eml/eml/+coder/+internal/isDomainError.m"),
                "resolved", 130);
  emlrtAddField(*info, b_emlrt_marshallOut(1419354984U), "fileTimeLo", 130);
  ...
  emlrtAddField(*info, emlrt_marshallOut(
    "[ILXE]/usr/local/MATLAB/R2015b/toolbox/eml/eml/+coder/+internal/+scalar/log2.m"),
                "resolved", 131);
  emlrtAddField(*info, b_emlrt_marshallOut(1419335426U), "fileTimeLo", 131);
  ...
  emlrtAddField(*info, emlrt_marshallOut(
    "[ILXE]/usr/local/MATLAB/R2015b/toolbox/eml/eml/+coder/+internal/applyScalarFunction.m"),
                "resolved", 132);
  emlrtAddField(*info, b_emlrt_marshallOut(1422905902U), "fileTimeLo", 132);
  ...
  emlrtAddField(*info, emlrt_marshallOut(
    "[ILXE]/usr/local/MATLAB/R2015b/toolbox/eml/eml/+coder/+internal/+scalar/log2.m"),
                "resolved", 133);
  emlrtAddField(*info, b_emlrt_marshallOut(1419335426U), "fileTimeLo", 133);
  ...
  emlrtAddField(*info, emlrt_marshallOut(
    "[ILXE]/usr/local/MATLAB/R2015b/toolbox/eml/eml/+coder/+internal/+scalar/log2.m"),
                "context", 134);
  emlrtAddField(*info, emlrt_marshallOut("realmax"), "name", 134);
  ...
  emlrtAddField(*info, emlrt_marshallOut(
    "[ILXE]/usr/local/MATLAB/R2015b/toolbox/eml/lib/matlab/elmat/realmax.m"),
                "resolved", 134);
  emlrtAddField(*info, b_emlrt_marshallOut(1415929532U), "fileTimeLo", 134);
  ...
  emlrtAddField(*info, emlrt_marshallOut(
    "[ILXE]/usr/local/MATLAB/R2015b/toolbox/eml/lib/matlab/elmat/realmax.m"),
                "context", 135);
  emlrtAddField(*info, emlrt_marshallOut("eml_realmax"), "name", 135);
  ...
  emlrtAddField(*info, emlrt_marshallOut(
    "[ILXE]/usr/local/MATLAB/R2015b/toolbox/eml/lib/matlab/ops/mrdivide.p"),
                "resolved", 137);
  emlrtAddField(*info, b_emlrt_marshallOut(1431720334U), "fileTimeLo", 137);
  ...
  emlrtAddField(*info, emlrt_marshallOut(
    "[ILXE]/usr/local/MATLAB/R2015b/toolbox/eml/lib/matlab/elmat/isfinite.m"),
                "resolved", 138);
  emlrtAddField(*info, b_emlrt_marshallOut(1415929532U), "fileTimeLo", 138);
  ...
  emlrtAddField(*info, emlrt_marshallOut(
    "[ILXE]/usr/local/MATLAB/R2015b/toolbox/eml/lib/matlab/elfun/floor.m"),
                "resolved", 140);
  emlrtAddField(*info, b_emlrt_marshallOut(1419335428U), "fileTimeLo", 140);
  ...
  emlrtAddField(*info, emlrt_marshallOut(
    "[IXC]/usr/local/MATLAB/R2015b/toolbox/comm/comm/compiled/+commcodegen/PhaseFrequencyOffset.p"),
                "context", 141);
  emlrtAddField(*info, emlrt_marshallOut("matlab.system.coder.System"), "name",
                141);
  emlrtAddField(*info, emlrt_marshallOut("unknown"), "dominantType", 141);
  emlrtAddField(*info, emlrt_marshallOut(
    "[IXC]/usr/local/MATLAB/R2015b/toolbox/shared/system/coder/+matlab/+system/+coder/System.p"),
                "resolved", 141);
  emlrtAddField(*info, b_emlrt_marshallOut(1431715898U), "fileTimeLo", 141);
  ...
  emlrtAddField(*info, emlrt_marshallOut("matlab.system.mixin.coder.Nondirect"),
                "name", 142);
  emlrtAddField(*info, emlrt_marshallOut("unknown"), "dominantType", 142);
  emlrtAddField(*info, emlrt_marshallOut(
    "[IXC]/usr/local/MATLAB/R2015b/toolbox/shared/system/coder/+matlab/+system/+mixin/+coder/Nondirect.p"),
                "resolved", 142);
  emlrtAddField(*info, b_emlrt_marshallOut(1431715898U), "fileTimeLo", 142);
  ...
  emlrtAddField(*info, emlrt_marshallOut(
    "[E]/usr/local/MATLAB/V40_demo/drx/rffe_timing/rffe_100.m"), "context", 143);
  ...
  emlrtAddField(*info, emlrt_marshallOut(
    "[IXC]/usr/local/MATLAB/R2015b/toolbox/comm/comm/compiled/+commcodegen/PhaseFrequencyOffset.p"),
                "resolved", 143);
  emlrtAddField(*info, b_emlrt_marshallOut(1431726592U), "fileTimeLo", 143);
  ...
  emlrtAddField(*info, emlrt_marshallOut(
    "[IXC]/usr/local/MATLAB/R2015b/toolbox/comm/comm/compiled/+commcodegen/PhaseFrequencyOffset.p"),
                "context", 144);
  emlrtAddField(*info, emlrt_marshallOut("createsystemobjectv2"), "name", 144);
  ...
  emlrtAddField(*info, emlrt_marshallOut(
    "[ILXE]/usr/local/MATLAB/R2015b/toolbox/eml/lib/scomp/createsystemobjectv2.m"),
                "resolved", 144);
  emlrtAddField(*info, b_emlrt_marshallOut(1416015006U), "fileTimeLo", 144);
  ...
  emlrtAddField(*info, emlrt_marshallOut(
    "[IXC]/usr/local/MATLAB/R2015b/toolbox/shared/system/coder/+matlab/+system/+coder/SystemProp.p"),
                "context", 145);
  emlrtAddField(*info, emlrt_marshallOut("matlab.system.pvParse"), "name", 145);
  emlrtAddField(*info, emlrt_marshallOut("commcodegen.PhaseFrequencyOffset"),
                "dominantType", 145);
  emlrtAddField(*info, emlrt_marshallOut(
    "[IXE]/usr/local/MATLAB/R2015b/toolbox/matlab/system/+matlab/+system/pvParse.p"),
                "resolved", 145);
  emlrtAddField(*info, b_emlrt_marshallOut(1431666890U), "fileTimeLo", 145);
  ...
  emlrtAddField(*info, emlrt_marshallOut(
    "[IXC]/usr/local/MATLAB/R2015b/toolbox/comm/comm/compiled/+commcodegen/PhaseFrequencyOffset.p"),
                "resolved", 146);
  emlrtAddField(*info, b_emlrt_marshallOut(1431726592U), "fileTimeLo", 146);
  ...
  emlrtAddField(*info, emlrt_marshallOut(
    "[IXC]/usr/local/MATLAB/R2015b/toolbox/comm/comm/compiled/+commcodegen/PhaseFrequencyOffset.p"),
                "context", 147);
  emlrtAddField(*info, emlrt_marshallOut("get_impl"), "name", 147);
  ...
  emlrtAddField(*info, emlrt_marshallOut(
    "[ILXE]/usr/local/MATLAB/R2015b/toolbox/eml/lib/fixedpoint/get_impl.m"),
                "resolved", 147);
  emlrtAddField(*info, b_emlrt_marshallOut(1415929522U), "fileTimeLo", 147);
  ...
  emlrtAddField(*info, emlrt_marshallOut(
    "[IXC]/usr/local/MATLAB/R2015b/toolbox/comm/comm/compiled/+commcodegen/PhaseFrequencyOffset.p"),
                "context", 148);
  emlrtAddField(*info, emlrt_marshallOut("setSfunSystemObject"), "name", 148);
  emlrtAddField(*info, emlrt_marshallOut("comm.PhaseFrequencyOffset"),
                "dominantType", 148);
  emlrtAddField(*info, emlrt_marshallOut(
    "[ILXE]/usr/local/MATLAB/R2015b/toolbox/eml/lib/scomp/setSfunSystemObject.m"),
                "resolved", 148);
  emlrtAddField(*info, b_emlrt_marshallOut(1415929546U), "fileTimeLo", 148);
  ...
  emlrtAddField(*info, emlrt_marshallOut(
    "[ILXE]/usr/local/MATLAB/R2015b/toolbox/eml/lib/scomp/checkSystemObjectInput.m"),
                "resolved", 149);
  emlrtAddField(*info, b_emlrt_marshallOut(1415929546U), "fileTimeLo", 149);
  ...
  emlrtAddField(*info, emlrt_marshallOut(
    "[IXC]/usr/local/MATLAB/R2015b/toolbox/comm/comm/+comm/+internal/RaisedCosineFilterBase.m"),
                "context", 150);
  emlrtAddField(*info, emlrt_marshallOut("matlab.system.coder.System"), "name",
                150);
  emlrtAddField(*info, emlrt_marshallOut("unknown"), "dominantType", 150);
  emlrtAddField(*info, emlrt_marshallOut(
    "[IXC]/usr/local/MATLAB/R2015b/toolbox/shared/system/coder/+matlab/+system/+coder/System.p"),
                "resolved", 150);
  emlrtAddField(*info, b_emlrt_marshallOut(1431715898U), "fileTimeLo", 150);
  ...
  emlrtAddField(*info, emlrt_marshallOut(
    "[IXC]/usr/local/MATLAB/R2015b/toolbox/comm/comm/+comm/RaisedCosineReceiveFilter.m"),
                "context", 151);
  emlrtAddField(*info, emlrt_marshallOut("comm.internal.RaisedCosineFilterBase"),
                "name", 151);
  emlrtAddField(*info, emlrt_marshallOut("unknown"), "dominantType", 151);
  emlrtAddField(*info, emlrt_marshallOut(
    "[IXC]/usr/local/MATLAB/R2015b/toolbox/comm/comm/+comm/+internal/RaisedCosineFilterBase.m"),
                "resolved", 151);
  emlrtAddField(*info, b_emlrt_marshallOut(1428691904U), "fileTimeLo", 151);
  ...
  emlrtAddField(*info, emlrt_marshallOut(
    "[E]/usr/local/MATLAB/V40_demo/drx/rffe_timing/rffe_100.m"), "context", 152);
  ...
  emlrtAddField(*info, emlrt_marshallOut(
    "[IXC]/usr/local/MATLAB/R2015b/toolbox/comm/comm/+comm/RaisedCosineReceiveFilter.m"),
                "resolved", 152);
  emlrtAddField(*info, b_emlrt_marshallOut(1370449700U), "fileTimeLo", 152);
  ...
  emlrtAddField(*info, emlrt_marshallOut(
    "[IXC]/usr/local/MATLAB/R2015b/toolbox/shared/system/coder/+matlab/+system/+coder/SystemProp.p"),
                "context", 153);
  emlrtAddField(*info, emlrt_marshallOut("matlab.system.pvParse"), "name", 153);
  emlrtAddField(*info, emlrt_marshallOut("comm.RaisedCosineReceiveFilter"),
                "dominantType", 153);
  emlrtAddField(*info, emlrt_marshallOut(
    "[IXE]/usr/local/MATLAB/R2015b/toolbox/matlab/system/+matlab/+system/pvParse.p"),
                "resolved", 153);
  emlrtAddField(*info, b_emlrt_marshallOut(1431666890U), "fileTimeLo", 153);
  ...
  emlrtAddField(*info, emlrt_marshallOut(
    "[IXC]/usr/local/MATLAB/R2015b/toolbox/comm/comm/+comm/RaisedCosineReceiveFilter.m"),
                "context", 154);
  emlrtAddField(*info, emlrt_marshallOut("validateattributes"), "name", 154);
  emlrtAddField(*info, emlrt_marshallOut("cell"), "dominantType", 154);
  emlrtAddField(*info, emlrt_marshallOut(
    "[ILXE]/usr/local/MATLAB/R2015b/toolbox/eml/lib/matlab/lang/validateattributes.m"),
                "resolved", 154);
  emlrtAddField(*info, b_emlrt_marshallOut(1421766848U), "fileTimeLo", 154);
  ...
  emlrtAddField(*info, emlrt_marshallOut(
    "[ILXE]/usr/local/MATLAB/R2015b/toolbox/eml/lib/matlab/lang/validateattributes.m!isintegral"),
                "context", 155);
  emlrtAddField(*info, emlrt_marshallOut("isfinite"), "name", 155);
  emlrtAddField(*info, emlrt_marshallOut("double"), "dominantType", 155);
  emlrtAddField(*info, emlrt_marshallOut(
    "[ILXE]/usr/local/MATLAB/R2015b/toolbox/eml/lib/matlab/elmat/isfinite.m"),
                "resolved", 155);
  emlrtAddField(*info, b_emlrt_marshallOut(1415929532U), "fileTimeLo", 155);
  ...
  emlrtAddField(*info, emlrt_marshallOut(
    "[ILXE]/usr/local/MATLAB/R2015b/toolbox/eml/lib/matlab/elfun/floor.m"),
                "resolved", 156);
  emlrtAddField(*info, b_emlrt_marshallOut(1419335428U), "fileTimeLo", 156);
  ...
  emlrtAddField(*info, emlrt_marshallOut(
    "[IXC]/usr/local/MATLAB/R2015b/toolbox/comm/comm/+comm/+internal/RaisedCosineFilterBase.m"),
                "context", 157);
  emlrtAddField(*info, emlrt_marshallOut("validateattributes"), "name", 157);
  emlrtAddField(*info, emlrt_marshallOut("cell"), "dominantType", 157);
  emlrtAddField(*info, emlrt_marshallOut(
    "[ILXE]/usr/local/MATLAB/R2015b/toolbox/eml/lib/matlab/lang/validateattributes.m"),
                "resolved", 157);
  emlrtAddField(*info, b_emlrt_marshallOut(1421766848U), "fileTimeLo", 157);
  ...
  emlrtAddField(*info, emlrt_marshallOut(
    "[ILXE]/usr/local/MATLAB/R2015b/toolbox/eml/lib/matlab/lang/validateattributes.m"),
                "context", 158);
  emlrtAddField(*info, emlrt_marshallOut("coder.internal.warning"), "name", 158);
  ...
  emlrtAddField(*info, emlrt_marshallOut(
    "[ILXE]/usr/local/MATLAB/R2015b/toolbox/shared/coder/coder/+coder/+internal/warning.m"),
                "resolved", 158);
  emlrtAddField(*info, b_emlrt_marshallOut(1415929548U), "fileTimeLo", 158);
  ...
  emlrtAddField(*info, emlrt_marshallOut(
    "[IXC]/usr/local/MATLAB/R2015b/toolbox/comm/comm/+comm/AGC.m"), "context",
                159);
  emlrtAddField(*info, emlrt_marshallOut("coder.internal.warning"), "name", 159);
  emlrtAddField(*info, emlrt_marshallOut("char"), "dominantType", 159);
  emlrtAddField(*info, emlrt_marshallOut(
    "[ILXE]/usr/local/MATLAB/R2015b/toolbox/shared/coder/coder/+coder/+internal/warning.m"),
                "resolved", 159);
  emlrtAddField(*info, b_emlrt_marshallOut(1415929548U), "fileTimeLo", 159);
  ...
  emlrtAddField(*info, emlrt_marshallOut(
    "[ILXE]/usr/local/MATLAB/R2015b/toolbox/eml/lib/matlab/lang/validateattributes.m"),
                "context", 160);
  emlrtAddField(*info, emlrt_marshallOut("iscolumn"), "name", 160);
  emlrtAddField(*info, emlrt_marshallOut("double"), "dominantType", 160);
  emlrtAddField(*info, emlrt_marshallOut(
    "[ILXE]/usr/local/MATLAB/R2015b/toolbox/eml/lib/matlab/elmat/iscolumn.m"),
                "resolved", 160);
  ...
  emlrtAddField(*info, emlrt_marshallOut(
    "[IXC]/usr/local/MATLAB/R2015b/toolbox/shared/system/coder/+matlab/+system/+coder/SystemProp.p"),
                "context", 161);
  emlrtAddField(*info, emlrt_marshallOut("issparse"), "name", 161);
  emlrtAddField(*info, emlrt_marshallOut("double"), "dominantType", 161);
  emlrtAddField(*info, emlrt_marshallOut(
    "[ILXE]/usr/local/MATLAB/R2015b/toolbox/eml/lib/matlab/sparfun/issparse.m"),
                "resolved", 161);
  emlrtAddField(*info, b_emlrt_marshallOut(1286840430U), "fileTimeLo", 161);
  ...
  emlrtAddField(*info, emlrt_marshallOut(
    "[IXC]/usr/local/MATLAB/R2015b/toolbox/comm/comm/+comm/AGC.m"), "context",
                162);
  emlrtAddField(*info, emlrt_marshallOut("log"), "name", 162);
  emlrtAddField(*info, emlrt_marshallOut("double"), "dominantType", 162);
  emlrtAddField(*info, emlrt_marshallOut(
    "[ILXE]/usr/local/MATLAB/R2015b/toolbox/eml/lib/matlab/elfun/log.m"),
                "resolved", 162);
  ...
  emlrtAddField(*info, emlrt_marshallOut(
    "[ILXE]/usr/local/MATLAB/R2015b/toolbox/eml/eml/+coder/+internal/error.m"),
                "resolved", 164);
  emlrtAddField(*info, b_emlrt_marshallOut(1419335426U), "fileTimeLo", 164);
  ...
  emlrtAddField(*info, emlrt_marshallOut(
    "[ILXE]/usr/local/MATLAB/R2015b/toolbox/eml/eml/+coder/+internal/+scalar/log.m"),
                "resolved", 165);
  emlrtAddField(*info, b_emlrt_marshallOut(1415929514U), "fileTimeLo", 165);
  ...
  emlrtAddField(*info, emlrt_marshallOut(
    "[ILXE]/usr/local/MATLAB/R2015b/toolbox/eml/eml/+coder/+internal/+scalar/log.m"),
                "resolved", 167);
  emlrtAddField(*info, b_emlrt_marshallOut(1415929514U), "fileTimeLo", 167);
  ...
  emlrtAddField(*info, emlrt_marshallOut(
    "[ILXE]/usr/local/MATLAB/R2015b/toolbox/eml/eml/+coder/+internal/+scalar/log.m"),
                "context", 168);
  emlrtAddField(*info, emlrt_marshallOut("realmax"), "name", 168);
  emlrtAddField(*info, emlrt_marshallOut("char"), "dominantType", 168);
  emlrtAddField(*info, emlrt_marshallOut(
    "[ILXE]/usr/local/MATLAB/R2015b/toolbox/eml/lib/matlab/elmat/realmax.m"),
                "resolved", 168);
  emlrtAddField(*info, b_emlrt_marshallOut(1415929532U), "fileTimeLo", 168);
  ...
  emlrtAddField(*info, emlrt_marshallOut(
    "[ILXE]/usr/local/MATLAB/R2015b/toolbox/eml/eml/+coder/+internal/+scalar/log.m"),
                "context", 169);
  emlrtAddField(*info, emlrt_marshallOut("mrdivide"), "name", 169);
  emlrtAddField(*info, emlrt_marshallOut("double"), "dominantType", 169);
  emlrtAddField(*info, emlrt_marshallOut(
    "[ILXE]/usr/local/MATLAB/R2015b/toolbox/eml/lib/matlab/ops/mrdivide.p"),
                "resolved", 169);
  emlrtAddField(*info, b_emlrt_marshallOut(1431720334U), "fileTimeLo", 169);
  emlrtAddField(*info, b_emlrt_marshallOut(0U), "fileTimeHi", 169);
  emlrtAddField(*info, b_emlrt_marshallOut(1415929540U), "mFileTimeLo", 169);
  ...
  emlrtAddField(*info, emlrt_marshallOut(
    "[ILXE]/usr/local/MATLAB/R2015b/toolbox/eml/lib/matlab/ops/mrdivide.p"),
                "resolved", 170);
  emlrtAddField(*info, b_emlrt_marshallOut(1431720334U), "fileTimeLo", 170);
  emlrtAddField(*info, b_emlrt_marshallOut(0U), "fileTimeHi", 170);
  emlrtAddField(*info, b_emlrt_marshallOut(1415929540U), "mFileTimeLo", 170);
  ...
  emlrtAddField(*info, emlrt_marshallOut(
    "[IXC]/usr/local/MATLAB/R2015b/toolbox/comm/comm/+comm/AGC.m"), "context",
                171);
  emlrtAddField(*info, emlrt_marshallOut("mpower"), "name", 171);
  ...
  emlrtAddField(*info, emlrt_marshallOut(
    "[ILXE]/usr/local/MATLAB/R2015b/toolbox/eml/lib/matlab/ops/mpower.m"),
                "resolved", 171);
  emlrtAddField(*info, b_emlrt_marshallOut(1415929538U), "fileTimeLo", 171);
  ...
  emlrtAddField(*info, emlrt_marshallOut(
    "[ILXE]/usr/local/MATLAB/R2015b/toolbox/eml/lib/matlab/ops/mpower.m"),
                "context", 173);
  emlrtAddField(*info, emlrt_marshallOut("ismatrix"), "name", 173);
  ...
  emlrtAddField(*info, emlrt_marshallOut(
    "[ILXE]/usr/local/MATLAB/R2015b/toolbox/eml/lib/matlab/elmat/ismatrix.m"),
                "resolved", 173);
  emlrtAddField(*info, b_emlrt_marshallOut(1415929532U), "fileTimeLo", 173);
  ...
  emlrtAddField(*info, emlrt_marshallOut(
    "[ILXE]/usr/local/MATLAB/R2015b/toolbox/eml/lib/matlab/ops/power.m"),
                "resolved", 174);
  emlrtAddField(*info, b_emlrt_marshallOut(1419335430U), "fileTimeLo", 174);
  ...
  emlrtAddField(*info, emlrt_marshallOut(
    "[ILXE]/usr/local/MATLAB/R2015b/toolbox/eml/eml/+coder/+internal/scalarEg.m"),
                "resolved", 176);
  emlrtAddField(*info, b_emlrt_marshallOut(1415929516U), "fileTimeLo", 176);
  ...
  emlrtAddField(*info, emlrt_marshallOut(
    "[ILXE]/usr/local/MATLAB/R2015b/toolbox/eml/eml/+coder/+internal/applyScalarFunction.m"),
                "resolved", 177);
  emlrtAddField(*info, b_emlrt_marshallOut(1422905902U), "fileTimeLo", 177);
  ...
  emlrtAddField(*info, emlrt_marshallOut(
    "[ILXE]/usr/local/MATLAB/R2015b/toolbox/eml/eml/+coder/+internal/scalarEg.m"),
                "resolved", 178);
  emlrtAddField(*info, b_emlrt_marshallOut(1415929516U), "fileTimeLo", 178);
  ...
  emlrtAddField(*info, emlrt_marshallOut(
    "[ILXE]/usr/local/MATLAB/R2015b/toolbox/eml/lib/matlab/elmat/isnan.m"),
                "resolved", 179);
  emlrtAddField(*info, b_emlrt_marshallOut(1415929532U), "fileTimeLo", 179);
  ...
  emlrtAddField(*info, emlrt_marshallOut(
    "[ILXE]/usr/local/MATLAB/R2015b/toolbox/eml/lib/matlab/ops/power.m!fltpower_domain_error"),
                "context", 180);
  emlrtAddField(*info, emlrt_marshallOut("floor"), "name", 180);
  emlrtAddField(*info, emlrt_marshallOut("double"), "dominantType", 180);
  emlrtAddField(*info, emlrt_marshallOut(
    "[ILXE]/usr/local/MATLAB/R2015b/toolbox/eml/lib/matlab/elfun/floor.m"),
                "resolved", 180);
  emlrtAddField(*info, b_emlrt_marshallOut(1419335428U), "fileTimeLo", 180);
  ...
  emlrtAddField(*info, emlrt_marshallOut(
    "[ILXE]/usr/local/MATLAB/R2015b/toolbox/eml/lib/matlab/ops/power.m!fltpower"),
                "context", 181);
  emlrtAddField(*info, emlrt_marshallOut("coder.internal.error"), "name", 181);
  emlrtAddField(*info, emlrt_marshallOut("char"), "dominantType", 181);
  emlrtAddField(*info, emlrt_marshallOut(
    "[ILXE]/usr/local/MATLAB/R2015b/toolbox/eml/eml/+coder/+internal/error.m"),
                "resolved", 181);
  emlrtAddField(*info, b_emlrt_marshallOut(1419335426U), "fileTimeLo", 181);
  ...
  emlrtAddField(*info, emlrt_marshallOut(
    "[ILXE]/usr/local/MATLAB/R2015b/toolbox/eml/lib/matlab/elfun/abs.m"),
                "resolved", 182);
  emlrtAddField(*info, b_emlrt_marshallOut(1419335426U), "fileTimeLo", 182);
  ...
  emlrtAddField(*info, emlrt_marshallOut(
    "[ILXE]/usr/local/MATLAB/R2015b/toolbox/eml/eml/+coder/+internal/+scalar/abs.m"),
                "resolved", 184);
  emlrtAddField(*info, b_emlrt_marshallOut(1424715334U), "fileTimeLo", 184);
  ...
  emlrtAddField(*info, emlrt_marshallOut(
    "[ILXE]/usr/local/MATLAB/R2015b/toolbox/eml/eml/+coder/+internal/applyScalarFunction.m"),
                "resolved", 185);
  emlrtAddField(*info, b_emlrt_marshallOut(1422905902U), "fileTimeLo", 185);
  ...
  emlrtAddField(*info, emlrt_marshallOut(
    "[ILXE]/usr/local/MATLAB/R2015b/toolbox/eml/eml/+coder/+internal/useParforConst.m"),
                "resolved", 186);
  emlrtAddField(*info, b_emlrt_marshallOut(1420496098U), "fileTimeLo", 186);
  ...
  emlrtAddField(*info, emlrt_marshallOut(
    "[ILXE]/usr/local/MATLAB/R2015b/toolbox/eml/eml/+coder/+internal/useParfor.m"),
                "resolved", 187);
  emlrtAddField(*info, b_emlrt_marshallOut(1422918514U), "fileTimeLo", 187);
  ...
  emlrtAddField(*info, emlrt_marshallOut(
    "[ILXE]/usr/local/MATLAB/R2015b/toolbox/eml/lib/matlab/eml/eml_int_forloop_overflow_check.m"),
                "resolved", 188);
  emlrtAddField(*info, b_emlrt_marshallOut(1415929534U), "fileTimeLo", 188);
  ...
  emlrtAddField(*info, emlrt_marshallOut(
    "[ILXE]/usr/local/MATLAB/R2015b/toolbox/eml/eml/+coder/+internal/+scalar/abs.m"),
                "resolved", 189);
  emlrtAddField(*info, b_emlrt_marshallOut(1424715334U), "fileTimeLo", 189);
  ...
  emlrtAddField(*info, emlrt_marshallOut(
    "[ILXE]/usr/local/MATLAB/R2015b/toolbox/eml/eml/+coder/+internal/+scalar/abs.m"),
                "context", 190);
  emlrtAddField(*info, emlrt_marshallOut("coder.internal.xdlapy2"), "name", 190);
  ...
  emlrtAddField(*info, emlrt_marshallOut(
    "[ILXE]/usr/local/MATLAB/R2015b/toolbox/eml/eml/+coder/+internal/xdlapy2.m"),
                "resolved", 190);
  emlrtAddField(*info, b_emlrt_marshallOut(1424714092U), "fileTimeLo", 190);
  ...
  emlrtAddField(*info, emlrt_marshallOut(
    "[IXC]/usr/local/MATLAB/R2015b/toolbox/comm/comm/+comm/AGC.m"), "context",
                191);
  emlrtAddField(*info, emlrt_marshallOut("power"), "name", 191);
  emlrtAddField(*info, emlrt_marshallOut("double"), "dominantType", 191);
  emlrtAddField(*info, emlrt_marshallOut(
    "[ILXE]/usr/local/MATLAB/R2015b/toolbox/eml/lib/matlab/ops/power.m"),
                "resolved", 191);
  emlrtAddField(*info, b_emlrt_marshallOut(1419335430U), "fileTimeLo", 191);
...
static void d_info_helper(const mxArray **info)
{
  ...
  emlrtAddField(*info, emlrt_marshallOut(
    "[ILXE]/usr/local/MATLAB/R2015b/toolbox/eml/lib/matlab/eml/eml_int_forloop_overflow_check.m"),
                "resolved", 192);
  emlrtAddField(*info, b_emlrt_marshallOut(1415929534U), "fileTimeLo", 192);
  ...
  emlrtAddField(*info, emlrt_marshallOut(
    "[IXC]/usr/local/MATLAB/R2015b/toolbox/comm/comm/+comm/AGC.m"), "context",
                193);
  emlrtAddField(*info, emlrt_marshallOut("filter"), "name", 193);
  emlrtAddField(*info, emlrt_marshallOut("double"), "dominantType", 193);
  emlrtAddField(*info, emlrt_marshallOut(
    "[ILXE]/usr/local/MATLAB/R2015b/toolbox/eml/lib/matlab/datafun/filter.m"),
                "resolved", 193);
  emlrtAddField(*info, b_emlrt_marshallOut(1419335426U), "fileTimeLo", 193);
  ...
  emlrtAddField(*info, emlrt_marshallOut(
    "[ILXE]/usr/local/MATLAB/R2015b/toolbox/eml/lib/matlab/datafun/filter.m"),
                "context", 194);
  emlrtAddField(*info, emlrt_marshallOut("max"), "name", 194);
  emlrtAddField(*info, emlrt_marshallOut("coder.internal.indexInt"),
                "dominantType", 194);
  emlrtAddField(*info, emlrt_marshallOut(
    "[ILXE]/usr/local/MATLAB/R2015b/toolbox/eml/lib/matlab/datafun/max.m"),
  ...
  emlrtAddField(*info, emlrt_marshallOut(
    "[ILXE]/usr/local/MATLAB/R2015b/toolbox/eml/eml/+coder/+internal/scalarEg.m"),
                "resolved", 196);
  emlrtAddField(*info, b_emlrt_marshallOut(1415929516U), "fileTimeLo", 196);
  ...
  emlrtAddField(*info, emlrt_marshallOut(
    "[ILXE]/usr/local/MATLAB/R2015b/toolbox/eml/lib/matlab/datafun/filter.m"),
                "context", 197);
  emlrtAddField(*info, emlrt_marshallOut("isfinite"), "name", 197);
  ...
  emlrtAddField(*info, emlrt_marshallOut(
    "[ILXE]/usr/local/MATLAB/R2015b/toolbox/eml/eml/+coder/+internal/prodsize.m"),
                "resolved", 198);
  emlrtAddField(*info, b_emlrt_marshallOut(1360304188U), "fileTimeLo", 198);
  ...
  emlrtAddField(*info, emlrt_marshallOut(
    "[ILXE]/usr/local/MATLAB/R2015b/toolbox/eml/lib/matlab/eml/eml_int_forloop_overflow_check.m"),
                "resolved", 199);
  emlrtAddField(*info, b_emlrt_marshallOut(1415929534U), "fileTimeLo", 199);
  ...
  emlrtAddField(*info, emlrt_marshallOut(
    "[ILXE]/usr/local/MATLAB/R2015b/toolbox/eml/eml/+coder/+internal/+blas/xaxpy.m"),
                "resolved", 200);
  emlrtAddField(*info, b_emlrt_marshallOut(1415929512U), "fileTimeLo", 200);
  ...
  emlrtAddField(*info, emlrt_marshallOut(
    "[ILXE]/usr/local/MATLAB/R2015b/toolbox/eml/eml/+coder/+internal/+blas/inline.m"),
                "resolved", 201);
  emlrtAddField(*info, b_emlrt_marshallOut(1376002264U), "fileTimeLo", 201);
  ...
  emlrtAddField(*info, emlrt_marshallOut(
    "[ILXE]/usr/local/MATLAB/R2015b/toolbox/eml/eml/+coder/+internal/+blas/use_refblas.m"),
                "resolved", 202);
  emlrtAddField(*info, b_emlrt_marshallOut(1376002264U), "fileTimeLo", 202);
  ...
  emlrtAddField(*info, emlrt_marshallOut(
    "[ILXE]/usr/local/MATLAB/R2015b/toolbox/eml/eml/+coder/+internal/+blas/xaxpy.m!below_threshold"),
                "context", 203);
  ...
  emlrtAddField(*info, emlrt_marshallOut(
    "[ILXE]/usr/local/MATLAB/R2015b/toolbox/eml/eml/+coder/+internal/+blas/threshold.m"),
                "resolved", 203);
  emlrtAddField(*info, b_emlrt_marshallOut(1376002264U), "fileTimeLo", 203);
  ...
  emlrtAddField(*info, emlrt_marshallOut(
    "[ILXE]/usr/local/MATLAB/R2015b/toolbox/eml/eml/+coder/+internal/+refblas/xaxpy.m"),
                "resolved", 205);
  emlrtAddField(*info, b_emlrt_marshallOut(1415929512U), "fileTimeLo", 205);
  ...
  emlrtAddField(*info, emlrt_marshallOut(
    "[ILXE]/usr/local/MATLAB/R2015b/toolbox/eml/lib/matlab/eml/eml_int_forloop_overflow_check.m"),
                "resolved", 209);
  emlrtAddField(*info, b_emlrt_marshallOut(1415929534U), "fileTimeLo", 209);
  ...
  emlrtAddField(*info, emlrt_marshallOut(
    "[ILXE]/usr/local/MATLAB/R2015b/toolbox/eml/eml/+coder/+internal/useParforConst.m"),
                "resolved", 211);
  emlrtAddField(*info, b_emlrt_marshallOut(1420496098U), "fileTimeLo", 211);
  ...
  emlrtAddField(*info, emlrt_marshallOut(
    "[ILXE]/usr/local/MATLAB/R2015b/toolbox/eml/lib/matlab/eml/eml_int_forloop_overflow_check.m"),
                "resolved", 212);
  emlrtAddField(*info, b_emlrt_marshallOut(1415929534U), "fileTimeLo", 212);
  ...
  emlrtAddField(*info, emlrt_marshallOut(
    "[IXC]/usr/local/MATLAB/R2015b/toolbox/comm/comm/+comm/AGC.m"), "context",
                213);
  emlrtAddField(*info, emlrt_marshallOut("coder.internal.length"), "name", 213);
  ...
  emlrtAddField(*info, emlrt_marshallOut(
    "[ILXE]/usr/local/MATLAB/R2015b/toolbox/eml/eml/+coder/+internal/length.m"),
                "resolved", 213);
  emlrtAddField(*info, b_emlrt_marshallOut(1429650858U), "fileTimeLo", 213);
  ...
  emlrtAddField(*info, emlrt_marshallOut(
    "[IXC]/usr/local/MATLAB/R2015b/toolbox/comm/comm/+comm/AGC.m"), "context",
                214);
  emlrtAddField(*info, emlrt_marshallOut("min"), "name", 214);
  ...
  emlrtAddField(*info, emlrt_marshallOut(
    "[ILXE]/usr/local/MATLAB/R2015b/toolbox/eml/lib/matlab/datafun/min.m"),
                "resolved", 214);
  emlrtAddField(*info, b_emlrt_marshallOut(1415929526U), "fileTimeLo", 214);
  ...
  emlrtAddField(*info, emlrt_marshallOut(
    "[ILXE]/usr/local/MATLAB/R2015b/toolbox/eml/lib/matlab/datafun/min.m"),
                "context", 215);
  emlrtAddField(*info, emlrt_marshallOut("coder.internal.minOrMax"), "name", 215);
  emlrtAddField(*info, emlrt_marshallOut("char"), "dominantType", 215);
  emlrtAddField(*info, emlrt_marshallOut(
    "[ILXE]/usr/local/MATLAB/R2015b/toolbox/eml/eml/+coder/+internal/minOrMax.m"),
                "resolved", 215);
  emlrtAddField(*info, b_emlrt_marshallOut(1426794442U), "fileTimeLo", 215);
  ...
  emlrtAddField(*info, emlrt_marshallOut(
    "[IXC]/usr/local/MATLAB/R2015b/toolbox/comm/comm/+comm/AGC.m"), "context",
                216);
  emlrtAddField(*info, emlrt_marshallOut("exp"), "name", 216);
  emlrtAddField(*info, emlrt_marshallOut("double"), "dominantType", 216);
  emlrtAddField(*info, emlrt_marshallOut(
    "[ILXE]/usr/local/MATLAB/R2015b/toolbox/eml/lib/matlab/elfun/exp.m"),
                "resolved", 216);
  emlrtAddField(*info, b_emlrt_marshallOut(1419335428U), "fileTimeLo", 216);
  ...
  emlrtAddField(*info, emlrt_marshallOut(
    "[ILXE]/usr/local/MATLAB/R2015b/toolbox/eml/eml/+coder/+internal/+scalar/exp.m"),
                "resolved", 217);
  emlrtAddField(*info, b_emlrt_marshallOut(1415929514U), "fileTimeLo", 217);
  ...
  emlrtAddField(*info, emlrt_marshallOut(
    "[ILXE]/usr/local/MATLAB/R2015b/toolbox/eml/lib/matlab/elfun/exp.m"),
                "context", 218);
  emlrtAddField(*info, emlrt_marshallOut(
    "coder.internal.applyScalarFunctionInPlace"), "name", 218);
  emlrtAddField(*info, emlrt_marshallOut("function_handle"), "dominantType", 218);
  emlrtAddField(*info, emlrt_marshallOut(
    "[ILXE]/usr/local/MATLAB/R2015b/toolbox/eml/eml/+coder/+internal/applyScalarFunctionInPlace.m"),
                "resolved", 218);
  emlrtAddField(*info, b_emlrt_marshallOut(1422905800U), "fileTimeLo", 218);
  ...
  emlrtAddField(*info, emlrt_marshallOut(
    "[ILXE]/usr/local/MATLAB/R2015b/toolbox/eml/eml/+coder/+internal/+scalar/exp.m"),
                "resolved", 219);
  emlrtAddField(*info, b_emlrt_marshallOut(1415929514U), "fileTimeLo", 219);
  ...
  emlrtAddField(*info, emlrt_marshallOut(
    "[ILXE]/usr/local/MATLAB/R2015b/toolbox/eml/eml/+coder/+internal/+scalar/exp.m"),
                "context", 220);
  emlrtAddField(*info, emlrt_marshallOut("isinf"), "name", 220);
  emlrtAddField(*info, emlrt_marshallOut("double"), "dominantType", 220);
  emlrtAddField(*info, emlrt_marshallOut(
    "[ILXE]/usr/local/MATLAB/R2015b/toolbox/eml/lib/matlab/elmat/isinf.m"),
                "resolved", 220);
  emlrtAddField(*info, b_emlrt_marshallOut(1415929532U), "fileTimeLo", 220);
  ...
  emlrtAddField(*info, emlrt_marshallOut(
    "[ILXE]/usr/local/MATLAB/R2015b/toolbox/eml/lib/matlab/ops/mrdivide.p"),
                "resolved", 221);
  emlrtAddField(*info, b_emlrt_marshallOut(1431720334U), "fileTimeLo", 221);
  emlrtAddField(*info, b_emlrt_marshallOut(0U), "fileTimeHi", 221);
  emlrtAddField(*info, b_emlrt_marshallOut(1415929540U), "mFileTimeLo", 221);
  ...
  emlrtAddField(*info, emlrt_marshallOut(
    "[IXC]/usr/local/MATLAB/R2015b/toolbox/dsp/dsp/compiled/+dspcodegen/FIRDecimator.p"),
                "context", 222);
  emlrtAddField(*info, emlrt_marshallOut("getNumInputs"), "name", 222);
  ...
  emlrtAddField(*info, emlrt_marshallOut(
    "[ILXE]/usr/local/MATLAB/R2015b/toolbox/eml/lib/scomp/getNumInputs.m"),
                "resolved", 222);
  emlrtAddField(*info, b_emlrt_marshallOut(1415929546U), "fileTimeLo", 222);
  ...
  emlrtAddField(*info, emlrt_marshallOut(
    "[ILXE]/usr/local/MATLAB/R2015b/toolbox/eml/lib/scomp/getNumInputs.m"),
                "context", 223);
  emlrtAddField(*info, emlrt_marshallOut("checkSystemObjectInput"), "name", 223);
  emlrtAddField(*info, emlrt_marshallOut("dsp.FIRDecimator"), "dominantType",
                223);
  emlrtAddField(*info, emlrt_marshallOut(
    "[ILXE]/usr/local/MATLAB/R2015b/toolbox/eml/lib/scomp/checkSystemObjectInput.m"),
                "resolved", 223);
  emlrtAddField(*info, b_emlrt_marshallOut(1415929546U), "fileTimeLo", 223);
  ...
  emlrtAddField(*info, emlrt_marshallOut(
    "[ILXE]/usr/local/MATLAB/R2015b/toolbox/eml/lib/scomp/getNumInputs.m"),
                "context", 224);
  emlrtAddField(*info, emlrt_marshallOut("eml_try_catch"), "name", 224);
  ...
  emlrtAddField(*info, emlrt_marshallOut(
    "[IXE]/usr/local/MATLAB/R2015b/toolbox/eml/eml/eml_try_catch.m"), "resolved",
                224);
  emlrtAddField(*info, b_emlrt_marshallOut(1294089542U), "fileTimeLo", 224);
  ...
  emlrtAddField(*info, emlrt_marshallOut(
    "[IXC]/usr/local/MATLAB/R2015b/toolbox/dsp/dsp/compiled/+dspcodegen/FIRDecimator.p"),
                "context", 225);
  emlrtAddField(*info, emlrt_marshallOut("setup"), "name", 225);
  emlrtAddField(*info, emlrt_marshallOut("dsp.FIRDecimator"), "dominantType",
                225);
  emlrtAddField(*info, emlrt_marshallOut(
    "[ILXE]/usr/local/MATLAB/R2015b/toolbox/eml/lib/scomp/setup.m"), "resolved",
                225);
  emlrtAddField(*info, b_emlrt_marshallOut(1415929546U), "fileTimeLo", 225);
  ...
  emlrtAddField(*info, emlrt_marshallOut(
    "[ILXE]/usr/local/MATLAB/R2015b/toolbox/eml/lib/scomp/setup.m"), "context",
                226);
  emlrtAddField(*info, emlrt_marshallOut("checkSystemObjectInput"), "name", 226);
  emlrtAddField(*info, emlrt_marshallOut("dsp.FIRDecimator"), "dominantType",
                226);
  emlrtAddField(*info, emlrt_marshallOut(
    "[ILXE]/usr/local/MATLAB/R2015b/toolbox/eml/lib/scomp/checkSystemObjectInput.m"),
                "resolved", 226);
  emlrtAddField(*info, b_emlrt_marshallOut(1415929546U), "fileTimeLo", 226);
  ...
  emlrtAddField(*info, emlrt_marshallOut(
    "[ILXE]/usr/local/MATLAB/R2015b/toolbox/eml/lib/scomp/setup.m"), "context",
                227);
  emlrtAddField(*info, emlrt_marshallOut("eml_try_catch"), "name", 227);
  emlrtAddField(*info, emlrt_marshallOut(""), "dominantType", 227);
  emlrtAddField(*info, emlrt_marshallOut(
    "[IXE]/usr/local/MATLAB/R2015b/toolbox/eml/eml/eml_try_catch.m"), "resolved",
                227);
  emlrtAddField(*info, b_emlrt_marshallOut(1294089542U), "fileTimeLo", 227);
  ...
  emlrtAddField(*info, emlrt_marshallOut(
    "[IXC]/usr/local/MATLAB/R2015b/toolbox/dsp/dsp/compiled/+dspcodegen/FIRDecimator.p"),
                "context", 228);
  emlrtAddField(*info, emlrt_marshallOut("reset"), "name", 228);
  emlrtAddField(*info, emlrt_marshallOut("dsp.FIRDecimator"), "dominantType",
                228);
  emlrtAddField(*info, emlrt_marshallOut(
    "[ILXE]/usr/local/MATLAB/R2015b/toolbox/eml/lib/scomp/reset.m"), "resolved",
                228);
  emlrtAddField(*info, b_emlrt_marshallOut(1391553532U), "fileTimeLo", 228);
  ...
  emlrtAddField(*info, emlrt_marshallOut(
    "[ILXE]/usr/local/MATLAB/R2015b/toolbox/eml/lib/scomp/reset.m"), "context",
                229);
  emlrtAddField(*info, emlrt_marshallOut("checkSystemObjectInput"), "name", 229);
  emlrtAddField(*info, emlrt_marshallOut("dsp.FIRDecimator"), "dominantType",
                229);
  emlrtAddField(*info, emlrt_marshallOut(
    "[ILXE]/usr/local/MATLAB/R2015b/toolbox/eml/lib/scomp/checkSystemObjectInput.m"),
                "resolved", 229);
  emlrtAddField(*info, b_emlrt_marshallOut(1415929546U), "fileTimeLo", 229);
  ...
  emlrtAddField(*info, emlrt_marshallOut(
    "[IXC]/usr/local/MATLAB/R2015b/toolbox/dsp/dsp/compiled/+dspcodegen/FIRDecimator.p"),
                "context", 230);
  emlrtAddField(*info, emlrt_marshallOut("getNumOutputs"), "name", 230);
  emlrtAddField(*info, emlrt_marshallOut("dsp.FIRDecimator"), "dominantType",
                230);
  emlrtAddField(*info, emlrt_marshallOut(
    "[ILXE]/usr/local/MATLAB/R2015b/toolbox/eml/lib/scomp/getNumOutputs.m"),
                "resolved", 230);
  emlrtAddField(*info, b_emlrt_marshallOut(1415929546U), "fileTimeLo", 230);
  ...
  emlrtAddField(*info, emlrt_marshallOut(
    "[ILXE]/usr/local/MATLAB/R2015b/toolbox/eml/lib/scomp/getNumOutputs.m"),
                "context", 231);
  emlrtAddField(*info, emlrt_marshallOut("checkSystemObjectInput"), "name", 231);
  emlrtAddField(*info, emlrt_marshallOut("dsp.FIRDecimator"), "dominantType",
                231);
  emlrtAddField(*info, emlrt_marshallOut(
    "[ILXE]/usr/local/MATLAB/R2015b/toolbox/eml/lib/scomp/checkSystemObjectInput.m"),
                "resolved", 231);
  emlrtAddField(*info, b_emlrt_marshallOut(1415929546U), "fileTimeLo", 231);
  ...
  emlrtAddField(*info, emlrt_marshallOut(
    "[ILXE]/usr/local/MATLAB/R2015b/toolbox/eml/lib/scomp/getNumOutputs.m"),
                "context", 232);
  emlrtAddField(*info, emlrt_marshallOut("eml_try_catch"), "name", 232);
  emlrtAddField(*info, emlrt_marshallOut(""), "dominantType", 232);
  emlrtAddField(*info, emlrt_marshallOut(
    "[IXE]/usr/local/MATLAB/R2015b/toolbox/eml/eml/eml_try_catch.m"), "resolved",
                232);
  emlrtAddField(*info, b_emlrt_marshallOut(1294089542U), "fileTimeLo", 232);
  ...
  emlrtAddField(*info, emlrt_marshallOut(
    "[IXC]/usr/local/MATLAB/R2015b/toolbox/dsp/dsp/compiled/+dspcodegen/FIRDecimator.p"),
                "context", 233);
  emlrtAddField(*info, emlrt_marshallOut("output"), "name", 233);
  emlrtAddField(*info, emlrt_marshallOut("dsp.FIRDecimator"), "dominantType",
                233);
  emlrtAddField(*info, emlrt_marshallOut(
    "[ILXE]/usr/local/MATLAB/R2015b/toolbox/eml/lib/scomp/output.m"), "resolved",
                233);
  emlrtAddField(*info, b_emlrt_marshallOut(1415929546U), "fileTimeLo", 233);
  ...
  emlrtAddField(*info, emlrt_marshallOut(
    "[ILXE]/usr/local/MATLAB/R2015b/toolbox/eml/lib/scomp/output.m"), "context",
                234);
  emlrtAddField(*info, emlrt_marshallOut("checkSystemObjectInput"), "name", 234);
  emlrtAddField(*info, emlrt_marshallOut("dsp.FIRDecimator"), "dominantType",
                234);
  emlrtAddField(*info, emlrt_marshallOut(
    "[ILXE]/usr/local/MATLAB/R2015b/toolbox/eml/lib/scomp/checkSystemObjectInput.m"),
                "resolved", 234);
  emlrtAddField(*info, b_emlrt_marshallOut(1415929546U), "fileTimeLo", 234);
  ...
  emlrtAddField(*info, emlrt_marshallOut(
    "[ILXE]/usr/local/MATLAB/R2015b/toolbox/eml/lib/scomp/output.m"), "context",
                235);
  emlrtAddField(*info, emlrt_marshallOut("eml_try_catch"), "name", 235);
  emlrtAddField(*info, emlrt_marshallOut(""), "dominantType", 235);
  emlrtAddField(*info, emlrt_marshallOut(
    "[IXE]/usr/local/MATLAB/R2015b/toolbox/eml/eml/eml_try_catch.m"), "resolved",
                235);
  emlrtAddField(*info, b_emlrt_marshallOut(1294089542U), "fileTimeLo", 235);
  ...
  emlrtAddField(*info, emlrt_marshallOut(
    "[IXC]/usr/local/MATLAB/R2015b/toolbox/dsp/dsp/compiled/+dspcodegen/FIRDecimator.p"),
                "context", 236);
  emlrtAddField(*info, emlrt_marshallOut("update"), "name", 236);
  emlrtAddField(*info, emlrt_marshallOut("dsp.FIRDecimator"), "dominantType",
                236);
  emlrtAddField(*info, emlrt_marshallOut(
    "[ILXE]/usr/local/MATLAB/R2015b/toolbox/eml/lib/scomp/update.m"), "resolved",
                236);
  emlrtAddField(*info, b_emlrt_marshallOut(1415929546U), "fileTimeLo", 236);
  ...
  emlrtAddField(*info, emlrt_marshallOut(
    "[ILXE]/usr/local/MATLAB/R2015b/toolbox/eml/lib/scomp/update.m"), "context",
                237);
  emlrtAddField(*info, emlrt_marshallOut("checkSystemObjectInput"), "name", 237);
  emlrtAddField(*info, emlrt_marshallOut("dsp.FIRDecimator"), "dominantType",
                237);
  emlrtAddField(*info, emlrt_marshallOut(
    "[ILXE]/usr/local/MATLAB/R2015b/toolbox/eml/lib/scomp/checkSystemObjectInput.m"),
                "resolved", 237);
  emlrtAddField(*info, b_emlrt_marshallOut(1415929546U), "fileTimeLo", 237);
  ...
  emlrtAddField(*info, emlrt_marshallOut(
    "[ILXE]/usr/local/MATLAB/R2015b/toolbox/eml/lib/scomp/update.m"), "context",
                238);
  emlrtAddField(*info, emlrt_marshallOut("eml_try_catch"), "name", 238);
  emlrtAddField(*info, emlrt_marshallOut(""), "dominantType", 238);
  emlrtAddField(*info, emlrt_marshallOut(
    "[IXE]/usr/local/MATLAB/R2015b/toolbox/eml/eml/eml_try_catch.m"), "resolved",
                238);
  emlrtAddField(*info, b_emlrt_marshallOut(1294089542U), "fileTimeLo", 238);
  ...
  emlrtAddField(*info, emlrt_marshallOut(
    "[IXC]/usr/local/MATLAB/R2015b/toolbox/comm/comm/+comm/PSKCoarseFrequencyEstimator.m"),
                "context", 239);
  emlrtAddField(*info, emlrt_marshallOut("strcmpi"), "name", 239);
  emlrtAddField(*info, emlrt_marshallOut("char"), "dominantType", 239);
  emlrtAddField(*info, emlrt_marshallOut(
    "[ILXE]/usr/local/MATLAB/R2015b/toolbox/eml/lib/matlab/strfun/strcmpi.m"),
                "resolved", 239);
  emlrtAddField(*info, b_emlrt_marshallOut(1428518594U), "fileTimeLo", 239);
  ...
  emlrtAddField(*info, emlrt_marshallOut(
    "[ILXE]/usr/local/MATLAB/R2015b/toolbox/eml/lib/matlab/elmat/iscolumn.m"),
                "resolved", 240);
  emlrtAddField(*info, b_emlrt_marshallOut(1415929532U), "fileTimeLo", 240);
  ...
  emlrtAddField(*info, emlrt_marshallOut(
    "[ILXE]/usr/local/MATLAB/R2015b/toolbox/eml/lib/matlab/ops/mrdivide.p"),
                "resolved", 241);
  emlrtAddField(*info, b_emlrt_marshallOut(1431720334U), "fileTimeLo", 241);
  emlrtAddField(*info, b_emlrt_marshallOut(0U), "fileTimeHi", 241);
  emlrtAddField(*info, b_emlrt_marshallOut(1415929540U), "mFileTimeLo", 241);
  ...
  emlrtAddField(*info, emlrt_marshallOut(
    "[ILXE]/usr/local/MATLAB/R2015b/toolbox/eml/lib/matlab/elfun/nextpow2.m"),
                "resolved", 242);
  emlrtAddField(*info, b_emlrt_marshallOut(1419335428U), "fileTimeLo", 242);
  ...
  emlrtAddField(*info, emlrt_marshallOut(
    "[ILXE]/usr/local/MATLAB/R2015b/toolbox/eml/eml/+coder/+internal/+scalar/nextpow2.m"),
                "resolved", 244);
  emlrtAddField(*info, b_emlrt_marshallOut(1419335426U), "fileTimeLo", 244);
  ...
  emlrtAddField(*info, emlrt_marshallOut(
    "[ILXE]/usr/local/MATLAB/R2015b/toolbox/eml/lib/matlab/elfun/nextpow2.m"),
                "context", 245);
  emlrtAddField(*info, emlrt_marshallOut(
    "coder.internal.applyScalarFunctionInPlace"), "name", 245);
  emlrtAddField(*info, emlrt_marshallOut("function_handle"), "dominantType", 245);
  emlrtAddField(*info, emlrt_marshallOut(
    "[ILXE]/usr/local/MATLAB/R2015b/toolbox/eml/eml/+coder/+internal/applyScalarFunctionInPlace.m"),
                "resolved", 245);
  emlrtAddField(*info, b_emlrt_marshallOut(1422905800U), "fileTimeLo", 245);
  ...
  emlrtAddField(*info, emlrt_marshallOut(
    "[ILXE]/usr/local/MATLAB/R2015b/toolbox/eml/eml/+coder/+internal/+scalar/nextpow2.m"),
                "resolved", 246);
  emlrtAddField(*info, b_emlrt_marshallOut(1419335426U), "fileTimeLo", 246);
  ...
  emlrtAddField(*info, emlrt_marshallOut(
    "[ILXE]/usr/local/MATLAB/R2015b/toolbox/eml/eml/+coder/+internal/+scalar/nextpow2.m!fnextpow2"),
                "context", 247);
  emlrtAddField(*info, emlrt_marshallOut("coder.internal.scalar.abs"), "name",
                247);
  ...
  emlrtAddField(*info, emlrt_marshallOut(
    "[ILXE]/usr/local/MATLAB/R2015b/toolbox/eml/eml/+coder/+internal/+scalar/abs.m"),
                "resolved", 247);
  emlrtAddField(*info, b_emlrt_marshallOut(1424715334U), "fileTimeLo", 247);
  ...
  emlrtAddField(*info, emlrt_marshallOut(
    "[ILXE]/usr/local/MATLAB/R2015b/toolbox/eml/eml/+coder/+internal/+scalar/nextpow2.m!fnextpow2"),
                "context", 248);
  emlrtAddField(*info, emlrt_marshallOut("isfinite"), "name", 248);
  emlrtAddField(*info, emlrt_marshallOut("double"), "dominantType", 248);
  emlrtAddField(*info, emlrt_marshallOut(
    "[ILXE]/usr/local/MATLAB/R2015b/toolbox/eml/lib/matlab/elmat/isfinite.m"),
                "resolved", 248);
  emlrtAddField(*info, b_emlrt_marshallOut(1415929532U), "fileTimeLo", 248);
  ...
  emlrtAddField(*info, emlrt_marshallOut(
    "[ILXE]/usr/local/MATLAB/R2015b/toolbox/eml/eml/+coder/+internal/+scalar/log2.m"),
                "resolved", 249);
  emlrtAddField(*info, b_emlrt_marshallOut(1419335426U), "fileTimeLo", 249);
  ...
  emlrtAddField(*info, emlrt_marshallOut(
    "[IXC]/usr/local/MATLAB/R2015b/toolbox/comm/comm/+comm/+internal/CoarseFrequencyEstimatorBase.m"),
                "context", 250);
  emlrtAddField(*info, emlrt_marshallOut("mpower"), "name", 250);
  emlrtAddField(*info, emlrt_marshallOut("double"), "dominantType", 250);
  emlrtAddField(*info, emlrt_marshallOut(
    "[ILXE]/usr/local/MATLAB/R2015b/toolbox/eml/lib/matlab/ops/mpower.m"),
                "resolved", 250);
  emlrtAddField(*info, b_emlrt_marshallOut(1415929538U), "fileTimeLo", 250);
  ...
  emlrtAddField(*info, emlrt_marshallOut(
    "[IXC]/usr/local/MATLAB/R2015b/toolbox/comm/comm/+comm/+internal/CoarseFrequencyEstimatorBase.m"),
                "context", 251);
  emlrtAddField(*info, emlrt_marshallOut("createsystemobjectv2"), "name", 251);
  emlrtAddField(*info, emlrt_marshallOut(""), "dominantType", 251);
  emlrtAddField(*info, emlrt_marshallOut(
    "[ILXE]/usr/local/MATLAB/R2015b/toolbox/eml/lib/scomp/createsystemobjectv2.m"),
                "resolved", 251);
  emlrtAddField(*info, b_emlrt_marshallOut(1416015006U), "fileTimeLo", 251);
  ...
  emlrtAddField(*info, emlrt_marshallOut(
    "[ILXE]/usr/local/MATLAB/R2015b/toolbox/eml/lib/matlab/ops/mrdivide.p"),
                "resolved", 252);
  emlrtAddField(*info, b_emlrt_marshallOut(1431720334U), "fileTimeLo", 252);
  emlrtAddField(*info, b_emlrt_marshallOut(0U), "fileTimeHi", 252);
  emlrtAddField(*info, b_emlrt_marshallOut(1415929540U), "mFileTimeLo", 252);
  ...
  emlrtAddField(*info, emlrt_marshallOut(
    "[ILXE]/usr/local/MATLAB/R2015b/toolbox/eml/lib/matlab/elfun/round.m"),
                "resolved", 253);
  emlrtAddField(*info, b_emlrt_marshallOut(1419335428U), "fileTimeLo", 253);
  ...
  emlrtAddField(*info, emlrt_marshallOut(
    "[ILXE]/usr/local/MATLAB/R2015b/toolbox/eml/eml/+coder/+internal/+scalar/round.m"),
                "resolved", 255);
  emlrtAddField(*info, b_emlrt_marshallOut(1415929514U), "fileTimeLo", 255);
...
static void e_info_helper(const mxArray **info)
{
  ...
  emlrtAddField(*info, emlrt_marshallOut(
    "[ILXE]/usr/local/MATLAB/R2015b/toolbox/eml/lib/matlab/elfun/round.m"),
                "context", 256);
  emlrtAddField(*info, emlrt_marshallOut(
    "coder.internal.applyScalarFunctionInPlace"), "name", 256);
  emlrtAddField(*info, emlrt_marshallOut("function_handle"), "dominantType", 256);
  emlrtAddField(*info, emlrt_marshallOut(
    "[ILXE]/usr/local/MATLAB/R2015b/toolbox/eml/eml/+coder/+internal/applyScalarFunctionInPlace.m"),
                "resolved", 256);
  emlrtAddField(*info, b_emlrt_marshallOut(1422905800U), "fileTimeLo", 256);
  ...
  emlrtAddField(*info, emlrt_marshallOut(
    "[ILXE]/usr/local/MATLAB/R2015b/toolbox/eml/eml/+coder/+internal/+scalar/round.m"),
                "resolved", 257);
  emlrtAddField(*info, b_emlrt_marshallOut(1415929514U), "fileTimeLo", 257);
  ...
  emlrtAddField(*info, emlrt_marshallOut(
    "[IXC]/usr/local/MATLAB/R2015b/toolbox/comm/comm/+comm/+internal/CoarseFrequencyEstimatorBase.m"),
                "context", 258);
  emlrtAddField(*info, emlrt_marshallOut("reset"), "name", 258);
  emlrtAddField(*info, emlrt_marshallOut("dsp.FFT"), "dominantType", 258);
  emlrtAddField(*info, emlrt_marshallOut(
    "[ILXE]/usr/local/MATLAB/R2015b/toolbox/eml/lib/scomp/reset.m"), "resolved",
                258);
  emlrtAddField(*info, b_emlrt_marshallOut(1391553532U), "fileTimeLo", 258);
  ...
  emlrtAddField(*info, emlrt_marshallOut(
    "[ILXE]/usr/local/MATLAB/R2015b/toolbox/eml/lib/scomp/reset.m"), "context",
                259);
  emlrtAddField(*info, emlrt_marshallOut("checkSystemObjectInput"), "name", 259);
  emlrtAddField(*info, emlrt_marshallOut("dsp.FFT"), "dominantType", 259);
  emlrtAddField(*info, emlrt_marshallOut(
    "[ILXE]/usr/local/MATLAB/R2015b/toolbox/eml/lib/scomp/checkSystemObjectInput.m"),
                "resolved", 259);
  emlrtAddField(*info, b_emlrt_marshallOut(1415929546U), "fileTimeLo", 259);
  ...
  emlrtAddField(*info, emlrt_marshallOut(
    "[ILXE]/usr/local/MATLAB/R2015b/toolbox/eml/lib/matlab/ops/power.m"),
                "resolved", 260);
  emlrtAddField(*info, b_emlrt_marshallOut(1419335430U), "fileTimeLo", 260);
  ...
  emlrtAddField(*info, emlrt_marshallOut(
    "[IXC]/usr/local/MATLAB/R2015b/toolbox/comm/comm/+comm/+internal/CoarseFrequencyEstimatorBase.m"),
                "context", 261);
  emlrtAddField(*info, emlrt_marshallOut("step"), "name", 261);
  emlrtAddField(*info, emlrt_marshallOut("dsp.FFT"), "dominantType", 261);
  emlrtAddField(*info, emlrt_marshallOut(
    "[ILXE]/usr/local/MATLAB/R2015b/toolbox/eml/lib/scomp/step.m"), "resolved",
                261);
  emlrtAddField(*info, b_emlrt_marshallOut(1415929546U), "fileTimeLo", 261);
  ...
  emlrtAddField(*info, emlrt_marshallOut(
    "[ILXE]/usr/local/MATLAB/R2015b/toolbox/eml/lib/scomp/step.m"), "context",
                262);
  emlrtAddField(*info, emlrt_marshallOut("checkSystemObjectInput"), "name", 262);
  emlrtAddField(*info, emlrt_marshallOut("dsp.FFT"), "dominantType", 262);
  emlrtAddField(*info, emlrt_marshallOut(
    "[ILXE]/usr/local/MATLAB/R2015b/toolbox/eml/lib/scomp/checkSystemObjectInput.m"),
                "resolved", 262);
  emlrtAddField(*info, b_emlrt_marshallOut(1415929546U), "fileTimeLo", 262);
  ...
  emlrtAddField(*info, emlrt_marshallOut(
    "[ILXE]/usr/local/MATLAB/R2015b/toolbox/eml/lib/scomp/step.m"), "context",
                263);
  emlrtAddField(*info, emlrt_marshallOut("eml_try_catch"), "name", 263);
  emlrtAddField(*info, emlrt_marshallOut(""), "dominantType", 263);
  emlrtAddField(*info, emlrt_marshallOut(
    "[IXE]/usr/local/MATLAB/R2015b/toolbox/eml/eml/eml_try_catch.m"), "resolved",
                263);
  emlrtAddField(*info, b_emlrt_marshallOut(1294089542U), "fileTimeLo", 263);
  ...
  emlrtAddField(*info, emlrt_marshallOut(
    "[ILXE]/usr/local/MATLAB/R2015b/toolbox/eml/lib/matlab/elfun/abs.m"),
                "resolved", 264);
  emlrtAddField(*info, b_emlrt_marshallOut(1419335426U), "fileTimeLo", 264);
  ...
  emlrtAddField(*info, emlrt_marshallOut(
    "[ILXE]/usr/local/MATLAB/R2015b/toolbox/eml/lib/matlab/datafun/fftshift.m"),
                "resolved", 265);
  emlrtAddField(*info, b_emlrt_marshallOut(1415929526U), "fileTimeLo", 265);
  ...
  emlrtAddField(*info, emlrt_marshallOut(
    "[ILXE]/usr/local/MATLAB/R2015b/toolbox/eml/lib/matlab/eml/eml_int_forloop_overflow_check.m"),
                "resolved", 266);
  emlrtAddField(*info, b_emlrt_marshallOut(1415929534U), "fileTimeLo", 266);
  ...
  emlrtAddField(*info, emlrt_marshallOut(
    "[ILXE]/usr/local/MATLAB/R2015b/toolbox/eml/lib/matlab/datafun/fftshift.m"),
                "context", 267);
  emlrtAddField(*info, emlrt_marshallOut("eml_fftshift"), "name", 267);
  emlrtAddField(*info, emlrt_marshallOut("double"), "dominantType", 267);
  emlrtAddField(*info, emlrt_marshallOut(
    "[ILXPE]/usr/local/MATLAB/R2015b/toolbox/eml/lib/matlab/datafun/private/eml_fftshift.m"),
                "resolved", 267);
  emlrtAddField(*info, b_emlrt_marshallOut(1415929526U), "fileTimeLo", 267);
  ...
  emlrtAddField(*info, emlrt_marshallOut(
    "[ILXPE]/usr/local/MATLAB/R2015b/toolbox/eml/lib/matlab/datafun/private/eml_fftshift.m"),
                "context", 269);
  emlrtAddField(*info, emlrt_marshallOut("coder.internal.prodsize"), "name", 269);
  emlrtAddField(*info, emlrt_marshallOut("double"), "dominantType", 269);
  emlrtAddField(*info, emlrt_marshallOut(
    "[ILXE]/usr/local/MATLAB/R2015b/toolbox/eml/eml/+coder/+internal/prodsize.m"),
                "resolved", 269);
  emlrtAddField(*info, b_emlrt_marshallOut(1360304188U), "fileTimeLo", 269);
  ...
  emlrtAddField(*info, emlrt_marshallOut(
    "[ILXE]/usr/local/MATLAB/R2015b/toolbox/eml/lib/matlab/eml/eml_int_forloop_overflow_check.m"),
                "resolved", 270);
  emlrtAddField(*info, b_emlrt_marshallOut(1415929534U), "fileTimeLo", 270);
  ...
  emlrtAddField(*info, emlrt_marshallOut(
    "[ILXE]/usr/local/MATLAB/R2015b/toolbox/shared/coder/coder/+coder/+internal/indexIntRelop.m"),
                "resolved", 274);
  emlrtAddField(*info, b_emlrt_marshallOut(1415929546U), "fileTimeLo", 274);
  ...
  emlrtAddField(*info, emlrt_marshallOut(
    "[ILXE]/usr/local/MATLAB/R2015b/toolbox/eml/lib/matlab/eml/eml_int_forloop_overflow_check.m"),
                "resolved", 275);
  emlrtAddField(*info, b_emlrt_marshallOut(1415929534U), "fileTimeLo", 275);
  ...
  emlrtAddField(*info, emlrt_marshallOut(
    "[ILXE]/usr/local/MATLAB/R2015b/toolbox/eml/lib/matlab/datafun/max.m"),
                "resolved", 278);
  emlrtAddField(*info, b_emlrt_marshallOut(1415929526U), "fileTimeLo", 278);
  ...
  emlrtAddField(*info, emlrt_marshallOut(
    "[ILXE]/usr/local/MATLAB/R2015b/toolbox/eml/eml/+coder/+internal/constNonSingletonDim.m"),
                "resolved", 279);
  emlrtAddField(*info, b_emlrt_marshallOut(1415929514U), "fileTimeLo", 279);
  ...
  emlrtAddField(*info, emlrt_marshallOut(
    "[ILXE]/usr/local/MATLAB/R2015b/toolbox/eml/eml/+coder/+internal/scalarEg.m"),
                "resolved", 280);
  emlrtAddField(*info, b_emlrt_marshallOut(1415929516U), "fileTimeLo", 280);
  ...
  emlrtAddField(*info, emlrt_marshallOut(
    "[ILXE]/usr/local/MATLAB/R2015b/toolbox/eml/lib/matlab/elmat/isnan.m"),
                "resolved", 281);
  emlrtAddField(*info, b_emlrt_marshallOut(1415929532U), "fileTimeLo", 281);
  ...
  emlrtAddField(*info, emlrt_marshallOut(
    "[ILXE]/usr/local/MATLAB/R2015b/toolbox/eml/lib/matlab/eml/eml_int_forloop_overflow_check.m"),
                "resolved", 282);
  emlrtAddField(*info, b_emlrt_marshallOut(1415929534U), "fileTimeLo", 282);
  ...
  emlrtAddField(*info, emlrt_marshallOut(
    "[ILXE]/usr/local/MATLAB/R2015b/toolbox/eml/eml/+coder/+internal/minOrMax.m!eml_extremum_sub"),
                "context", 283);
  emlrtAddField(*info, emlrt_marshallOut("coder.internal.relop"), "name", 283);
  ...
  emlrtAddField(*info, emlrt_marshallOut(
    "[ILXE]/usr/local/MATLAB/R2015b/toolbox/eml/eml/+coder/+internal/relop.m"),
                "resolved", 283);
  emlrtAddField(*info, b_emlrt_marshallOut(1415929516U), "fileTimeLo", 283);
  ...
  emlrtAddField(*info, emlrt_marshallOut(
    "[IXC]/usr/local/MATLAB/R2015b/toolbox/comm/comm/compiled/+commcodegen/PhaseFrequencyOffset.p"),
                "context", 284);
  emlrtAddField(*info, emlrt_marshallOut("getNumInputs"), "name", 284);
  emlrtAddField(*info, emlrt_marshallOut("comm.PhaseFrequencyOffset"),
                "dominantType", 284);
  emlrtAddField(*info, emlrt_marshallOut(
    "[ILXE]/usr/local/MATLAB/R2015b/toolbox/eml/lib/scomp/getNumInputs.m"),
                "resolved", 284);
  emlrtAddField(*info, b_emlrt_marshallOut(1415929546U), "fileTimeLo", 284);
  ...
  emlrtAddField(*info, emlrt_marshallOut(
    "[ILXE]/usr/local/MATLAB/R2015b/toolbox/eml/lib/scomp/getNumInputs.m"),
                "context", 285);
  emlrtAddField(*info, emlrt_marshallOut("checkSystemObjectInput"), "name", 285);
  emlrtAddField(*info, emlrt_marshallOut("comm.PhaseFrequencyOffset"),
                "dominantType", 285);
  emlrtAddField(*info, emlrt_marshallOut(
    "[ILXE]/usr/local/MATLAB/R2015b/toolbox/eml/lib/scomp/checkSystemObjectInput.m"),
                "resolved", 285);
  emlrtAddField(*info, b_emlrt_marshallOut(1415929546U), "fileTimeLo", 285);
  ...
  emlrtAddField(*info, emlrt_marshallOut(
    "[IXC]/usr/local/MATLAB/R2015b/toolbox/comm/comm/compiled/+commcodegen/PhaseFrequencyOffset.p"),
                "context", 286);
  emlrtAddField(*info, emlrt_marshallOut("setup"), "name", 286);
  emlrtAddField(*info, emlrt_marshallOut("comm.PhaseFrequencyOffset"),
                "dominantType", 286);
  emlrtAddField(*info, emlrt_marshallOut(
    "[ILXE]/usr/local/MATLAB/R2015b/toolbox/eml/lib/scomp/setup.m"), "resolved",
                286);
  emlrtAddField(*info, b_emlrt_marshallOut(1415929546U), "fileTimeLo", 286);
  ...
  emlrtAddField(*info, emlrt_marshallOut(
    "[ILXE]/usr/local/MATLAB/R2015b/toolbox/eml/lib/scomp/setup.m"), "context",
                287);
  emlrtAddField(*info, emlrt_marshallOut("checkSystemObjectInput"), "name", 287);
  emlrtAddField(*info, emlrt_marshallOut("comm.PhaseFrequencyOffset"),
                "dominantType", 287);
  emlrtAddField(*info, emlrt_marshallOut(
    "[ILXE]/usr/local/MATLAB/R2015b/toolbox/eml/lib/scomp/checkSystemObjectInput.m"),
                "resolved", 287);
  emlrtAddField(*info, b_emlrt_marshallOut(1415929546U), "fileTimeLo", 287);
  ...
  emlrtAddField(*info, emlrt_marshallOut(
    "[IXC]/usr/local/MATLAB/R2015b/toolbox/comm/comm/compiled/+commcodegen/PhaseFrequencyOffset.p"),
                "context", 288);
  emlrtAddField(*info, emlrt_marshallOut("reset"), "name", 288);
  emlrtAddField(*info, emlrt_marshallOut("comm.PhaseFrequencyOffset"),
                "dominantType", 288);
  emlrtAddField(*info, emlrt_marshallOut(
    "[ILXE]/usr/local/MATLAB/R2015b/toolbox/eml/lib/scomp/reset.m"), "resolved",
                288);
  emlrtAddField(*info, b_emlrt_marshallOut(1391553532U), "fileTimeLo", 288);
  ...
  emlrtAddField(*info, emlrt_marshallOut(
    "[ILXE]/usr/local/MATLAB/R2015b/toolbox/eml/lib/scomp/reset.m"), "context",
                289);
  emlrtAddField(*info, emlrt_marshallOut("checkSystemObjectInput"), "name", 289);
  emlrtAddField(*info, emlrt_marshallOut("comm.PhaseFrequencyOffset"),
                "dominantType", 289);
  emlrtAddField(*info, emlrt_marshallOut(
    "[ILXE]/usr/local/MATLAB/R2015b/toolbox/eml/lib/scomp/checkSystemObjectInput.m"),
                "resolved", 289);
  emlrtAddField(*info, b_emlrt_marshallOut(1415929546U), "fileTimeLo", 289);
  ...
  emlrtAddField(*info, emlrt_marshallOut(
    "[IXC]/usr/local/MATLAB/R2015b/toolbox/comm/comm/compiled/+commcodegen/PhaseFrequencyOffset.p"),
                "context", 290);
  emlrtAddField(*info, emlrt_marshallOut("getNumOutputs"), "name", 290);
  emlrtAddField(*info, emlrt_marshallOut("comm.PhaseFrequencyOffset"),
                "dominantType", 290);
  emlrtAddField(*info, emlrt_marshallOut(
    "[ILXE]/usr/local/MATLAB/R2015b/toolbox/eml/lib/scomp/getNumOutputs.m"),
                "resolved", 290);
  emlrtAddField(*info, b_emlrt_marshallOut(1415929546U), "fileTimeLo", 290);
  ...
  emlrtAddField(*info, emlrt_marshallOut(
    "[ILXE]/usr/local/MATLAB/R2015b/toolbox/eml/lib/scomp/getNumOutputs.m"),
                "context", 291);
  emlrtAddField(*info, emlrt_marshallOut("checkSystemObjectInput"), "name", 291);
  emlrtAddField(*info, emlrt_marshallOut("comm.PhaseFrequencyOffset"),
                "dominantType", 291);
  emlrtAddField(*info, emlrt_marshallOut(
    "[ILXE]/usr/local/MATLAB/R2015b/toolbox/eml/lib/scomp/checkSystemObjectInput.m"),
                "resolved", 291);
  emlrtAddField(*info, b_emlrt_marshallOut(1415929546U), "fileTimeLo", 291);
  ...
  emlrtAddField(*info, emlrt_marshallOut(
    "[IXC]/usr/local/MATLAB/R2015b/toolbox/comm/comm/compiled/+commcodegen/PhaseFrequencyOffset.p"),
                "context", 292);
  emlrtAddField(*info, emlrt_marshallOut("output"), "name", 292);
  emlrtAddField(*info, emlrt_marshallOut("comm.PhaseFrequencyOffset"),
                "dominantType", 292);
  emlrtAddField(*info, emlrt_marshallOut(
    "[ILXE]/usr/local/MATLAB/R2015b/toolbox/eml/lib/scomp/output.m"), "resolved",
                292);
  emlrtAddField(*info, b_emlrt_marshallOut(1415929546U), "fileTimeLo", 292);
  ...
  emlrtAddField(*info, emlrt_marshallOut(
    "[ILXE]/usr/local/MATLAB/R2015b/toolbox/eml/lib/scomp/output.m"), "context",
                293);
  emlrtAddField(*info, emlrt_marshallOut("checkSystemObjectInput"), "name", 293);
  emlrtAddField(*info, emlrt_marshallOut("comm.PhaseFrequencyOffset"),
                "dominantType", 293);
  emlrtAddField(*info, emlrt_marshallOut(
    "[ILXE]/usr/local/MATLAB/R2015b/toolbox/eml/lib/scomp/checkSystemObjectInput.m"),
                "resolved", 293);
  emlrtAddField(*info, b_emlrt_marshallOut(1415929546U), "fileTimeLo", 293);
  ...
  emlrtAddField(*info, emlrt_marshallOut(
    "[IXC]/usr/local/MATLAB/R2015b/toolbox/comm/comm/compiled/+commcodegen/PhaseFrequencyOffset.p"),
                "context", 294);
  emlrtAddField(*info, emlrt_marshallOut("update"), "name", 294);
  emlrtAddField(*info, emlrt_marshallOut("comm.PhaseFrequencyOffset"),
                "dominantType", 294);
  emlrtAddField(*info, emlrt_marshallOut(
    "[ILXE]/usr/local/MATLAB/R2015b/toolbox/eml/lib/scomp/update.m"), "resolved",
                294);
  emlrtAddField(*info, b_emlrt_marshallOut(1415929546U), "fileTimeLo", 294);
  ...
  emlrtAddField(*info, emlrt_marshallOut(
    "[ILXE]/usr/local/MATLAB/R2015b/toolbox/eml/lib/scomp/checkSystemObjectInput.m"),
                "resolved", 295);
  emlrtAddField(*info, b_emlrt_marshallOut(1415929546U), "fileTimeLo", 295);
  ...
  emlrtAddField(*info, emlrt_marshallOut(
    "[ILXE]/usr/local/MATLAB/R2015b/toolbox/eml/lib/matlab/ops/mrdivide.p"),
                "resolved", 296);
  emlrtAddField(*info, b_emlrt_marshallOut(1431720334U), "fileTimeLo", 296);
  emlrtAddField(*info, b_emlrt_marshallOut(0U), "fileTimeHi", 296);
  emlrtAddField(*info, b_emlrt_marshallOut(1415929540U), "mFileTimeLo", 296);
  ...
  emlrtAddField(*info, emlrt_marshallOut(
    "[IXC]/usr/local/MATLAB/R2015b/toolbox/comm/comm/+comm/RaisedCosineReceiveFilter.m"),
                "context", 297);
  emlrtAddField(*info, emlrt_marshallOut("round"), "name", 297);
  emlrtAddField(*info, emlrt_marshallOut("double"), "dominantType", 297);
  emlrtAddField(*info, emlrt_marshallOut(
    "[ILXE]/usr/local/MATLAB/R2015b/toolbox/eml/lib/matlab/elfun/round.m"),
                "resolved", 297);
  emlrtAddField(*info, b_emlrt_marshallOut(1419335428U), "fileTimeLo", 297);
  ...
  emlrtAddField(*info, emlrt_marshallOut(
    "[IXC]/usr/local/MATLAB/R2015b/toolbox/comm/comm/+comm/+internal/RaisedCosineFilterBase.m"),
                "context", 298);
  emlrtAddField(*info, emlrt_marshallOut("strncmp"), "name", 298);
  ...
  emlrtAddField(*info, emlrt_marshallOut(
    "[ILXE]/usr/local/MATLAB/R2015b/toolbox/eml/lib/matlab/strfun/strncmp.m"),
                "resolved", 298);
  emlrtAddField(*info, b_emlrt_marshallOut(1428518688U), "fileTimeLo", 298);
  ...
  emlrtAddField(*info, emlrt_marshallOut(
    "[ILXE]/usr/local/MATLAB/R2015b/toolbox/shared/coder/coder/+coder/+internal/narginchk.m"),
                "resolved", 299);
  emlrtAddField(*info, b_emlrt_marshallOut(1363732558U), "fileTimeLo", 299);
  ...
  emlrtAddField(*info, emlrt_marshallOut(
    "[ILXE]/usr/local/MATLAB/R2015b/toolbox/eml/lib/matlab/strfun/strncmp.m"),
                "context", 300);
  emlrtAddField(*info, emlrt_marshallOut("coder.internal.strcmp"), "name", 300);
  emlrtAddField(*info, emlrt_marshallOut("char"), "dominantType", 300);
  emlrtAddField(*info, emlrt_marshallOut(
    "[ILXE]/usr/local/MATLAB/R2015b/toolbox/eml/eml/+coder/+internal/strcmp.m"),
                "resolved", 300);
  emlrtAddField(*info, b_emlrt_marshallOut(1428952968U), "fileTimeLo", 300);
  ...
  emlrtAddField(*info, emlrt_marshallOut(
    "[ILXE]/usr/local/MATLAB/R2015b/toolbox/eml/lib/matlab/datafun/min.m"),
                "resolved", 301);
  emlrtAddField(*info, b_emlrt_marshallOut(1415929526U), "fileTimeLo", 301);
  ...
  emlrtAddField(*info, emlrt_marshallOut(
    "[ILXE]/usr/local/MATLAB/R2015b/toolbox/eml/eml/+coder/+internal/minOrMax.m!eml_scalar_bin_extremum"),
                "context", 303);
  emlrtAddField(*info, emlrt_marshallOut("coder.internal.relop"), "name", 303);
  emlrtAddField(*info, emlrt_marshallOut("function_handle"), "dominantType", 303);
  emlrtAddField(*info, emlrt_marshallOut(
    "[ILXE]/usr/local/MATLAB/R2015b/toolbox/eml/eml/+coder/+internal/relop.m"),
                "resolved", 303);
  emlrtAddField(*info, b_emlrt_marshallOut(1415929516U), "fileTimeLo", 303);
  ...
  emlrtAddField(*info, emlrt_marshallOut(
    "[ILXE]/usr/local/MATLAB/R2015b/toolbox/shared/coder/coder/+coder/+internal/indexIntRelop.m"),
                "resolved", 304);
  emlrtAddField(*info, b_emlrt_marshallOut(1415929546U), "fileTimeLo", 304);
  ...
  emlrtAddField(*info, emlrt_marshallOut(
    "[ILXE]/usr/local/MATLAB/R2015b/toolbox/eml/lib/matlab/elmat/isnan.m"),
                "resolved", 305);
  emlrtAddField(*info, b_emlrt_marshallOut(1415929532U), "fileTimeLo", 305);
  ...
  emlrtAddField(*info, emlrt_marshallOut(
    "[ILXE]/usr/local/MATLAB/R2015b/toolbox/eml/eml/+coder/+internal/isBuiltInNumeric.m"),
                "resolved", 306);
  emlrtAddField(*info, b_emlrt_marshallOut(1395949856U), "fileTimeLo", 306);
  ...
  emlrtAddField(*info, emlrt_marshallOut(
    "[IXC]/usr/local/MATLAB/R2015b/toolbox/comm/comm/+comm/+internal/RaisedCosineFilterBase.m"),
                "context", 307);
  emlrtAddField(*info, emlrt_marshallOut("rcosdesign"), "name", 307);
  emlrtAddField(*info, emlrt_marshallOut("double"), "dominantType", 307);
  emlrtAddField(*info, emlrt_marshallOut(
    "[IXE]/usr/local/MATLAB/R2015b/toolbox/signal/eml/rcosdesign.m"), "resolved",
                307);
  emlrtAddField(*info, b_emlrt_marshallOut(1376627754U), "fileTimeLo", 307);
  ...
  emlrtAddField(*info, emlrt_marshallOut(
    "[IXE]/usr/local/MATLAB/R2015b/toolbox/signal/eml/rcosdesign.m"), "context",
                308);
  emlrtAddField(*info, emlrt_marshallOut("eml_assert_all_constant"), "name", 308);
  emlrtAddField(*info, emlrt_marshallOut("double"), "dominantType", 308);
  emlrtAddField(*info, emlrt_marshallOut(
    "[ILXE]/usr/local/MATLAB/R2015b/toolbox/eml/lib/matlab/eml/eml_assert_all_constant.m"),
                "resolved", 308);
  emlrtAddField(*info, b_emlrt_marshallOut(1415929534U), "fileTimeLo", 308);
  ...
  emlrtAddField(*info, emlrt_marshallOut(
    "[ILXE]/usr/local/MATLAB/R2015b/toolbox/eml/lib/matlab/ops/power.m"),
                "resolved", 309);
  emlrtAddField(*info, b_emlrt_marshallOut(1419335430U), "fileTimeLo", 309);
  ...
  emlrtAddField(*info, emlrt_marshallOut(
    "[IXC]/usr/local/MATLAB/R2015b/toolbox/comm/comm/+comm/+internal/RaisedCosineFilterBase.m"),
                "context", 310);
  emlrtAddField(*info, emlrt_marshallOut("sum"), "name", 310);
  ...
  emlrtAddField(*info, emlrt_marshallOut(
    "[ILXE]/usr/local/MATLAB/R2015b/toolbox/eml/lib/matlab/datafun/sum.m"),
                "resolved", 310);
  emlrtAddField(*info, b_emlrt_marshallOut(1415929526U), "fileTimeLo", 310);
  ...
  emlrtAddField(*info, emlrt_marshallOut(
    "[ILXE]/usr/local/MATLAB/R2015b/toolbox/eml/lib/matlab/datafun/sum.m"),
                "context", 311);
  emlrtAddField(*info, emlrt_marshallOut("sumprod"), "name", 311);
  ...
  emlrtAddField(*info, emlrt_marshallOut(
    "[ILXPE]/usr/local/MATLAB/R2015b/toolbox/eml/lib/matlab/datafun/private/sumprod.m"),
                "resolved", 311);
  emlrtAddField(*info, b_emlrt_marshallOut(1415929526U), "fileTimeLo", 311);
  ...
  emlrtAddField(*info, emlrt_marshallOut(
    "[ILXPE]/usr/local/MATLAB/R2015b/toolbox/eml/lib/matlab/datafun/private/sumprod.m"),
                "context", 313);
  emlrtAddField(*info, emlrt_marshallOut("process_sumprod_inputs"), "name", 313);
  ...
  emlrtAddField(*info, emlrt_marshallOut(
    "[ILXPE]/usr/local/MATLAB/R2015b/toolbox/eml/lib/matlab/datafun/private/process_sumprod_inputs.m"),
                "resolved", 313);
  emlrtAddField(*info, b_emlrt_marshallOut(1415929526U), "fileTimeLo", 313);
  ...
  emlrtAddField(*info, emlrt_marshallOut(
    "[ILXE]/usr/local/MATLAB/R2015b/toolbox/shared/coder/coder/+coder/+internal/narginchk.m"),
                "resolved", 314);
  emlrtAddField(*info, b_emlrt_marshallOut(1363732558U), "fileTimeLo", 314);
  ...
  emlrtAddField(*info, emlrt_marshallOut(
    "[ILXE]/usr/local/MATLAB/R2015b/toolbox/eml/eml/+coder/+internal/constNonSingletonDim.m"),
                "resolved", 315);
  emlrtAddField(*info, b_emlrt_marshallOut(1415929514U), "fileTimeLo", 315);
  ...
  emlrtAddField(*info, emlrt_marshallOut(
    "[ILXE]/usr/local/MATLAB/R2015b/toolbox/eml/eml/+coder/+internal/scalarEg.m"),
                "resolved", 316);
  emlrtAddField(*info, b_emlrt_marshallOut(1415929516U), "fileTimeLo", 316);
  ...
  emlrtAddField(*info, emlrt_marshallOut(
    "[ILXPE]/usr/local/MATLAB/R2015b/toolbox/eml/lib/matlab/datafun/private/sumprod.m"),
                "context", 317);
  emlrtAddField(*info, emlrt_marshallOut("isequal"), "name", 317);
  ...
  emlrtAddField(*info, emlrt_marshallOut(
    "[ILXE]/usr/local/MATLAB/R2015b/toolbox/eml/lib/matlab/elmat/isequal.m"),
                "resolved", 317);
  emlrtAddField(*info, b_emlrt_marshallOut(1286840358U), "fileTimeLo", 317);
  ...
  emlrtAddField(*info, emlrt_marshallOut(
    "[ILXE]/usr/local/MATLAB/R2015b/toolbox/eml/lib/matlab/elmat/isequal.m"),
                "context", 318);
  emlrtAddField(*info, emlrt_marshallOut("eml_isequal_core"), "name", 318);
  ...
  emlrtAddField(*info, emlrt_marshallOut(
    "[ILXPE]/usr/local/MATLAB/R2015b/toolbox/eml/lib/matlab/elmat/private/eml_isequal_core.m"),
                "resolved", 318);
  emlrtAddField(*info, b_emlrt_marshallOut(1415929532U), "fileTimeLo", 318);
  ...
  emlrtAddField(*info, emlrt_marshallOut(
    "[ILXE]/usr/local/MATLAB/R2015b/toolbox/shared/coder/coder/+coder/+internal/narginchk.m"),
                "resolved", 319);
  emlrtAddField(*info, b_emlrt_marshallOut(1363732558U), "fileTimeLo", 319);
...
static void f_info_helper(const mxArray **info)
{
  ...
  emlrtAddField(*info, emlrt_marshallOut(
    "[ILXPE]/usr/local/MATLAB/R2015b/toolbox/eml/lib/matlab/datafun/private/sumprod.m"),
                "context", 320);
  emlrtAddField(*info, emlrt_marshallOut("combine_vector_elements"), "name", 320);
  emlrtAddField(*info, emlrt_marshallOut("function_handle"), "dominantType", 320);
  emlrtAddField(*info, emlrt_marshallOut(
    "[ILXPE]/usr/local/MATLAB/R2015b/toolbox/eml/lib/matlab/datafun/private/combine_vector_elements.m"),
                "resolved", 320);
  emlrtAddField(*info, b_emlrt_marshallOut(1419335426U), "fileTimeLo", 320);
  ...
  emlrtAddField(*info, emlrt_marshallOut(
    "[ILXE]/usr/local/MATLAB/R2015b/toolbox/eml/lib/matlab/eml/eml_int_forloop_overflow_check.m"),
                "resolved", 321);
  emlrtAddField(*info, b_emlrt_marshallOut(1415929534U), "fileTimeLo", 321);
  ...
  emlrtAddField(*info, emlrt_marshallOut(
    "[IXC]/usr/local/MATLAB/R2015b/toolbox/comm/comm/+comm/+internal/RaisedCosineFilterBase.m"),
                "context", 322);
  emlrtAddField(*info, emlrt_marshallOut("sqrt"), "name", 322);
  ...
  emlrtAddField(*info, emlrt_marshallOut(
    "[ILXE]/usr/local/MATLAB/R2015b/toolbox/eml/lib/matlab/elfun/sqrt.m"),
                "resolved", 322);
  emlrtAddField(*info, b_emlrt_marshallOut(1419335428U), "fileTimeLo", 322);
  ...
  emlrtAddField(*info, emlrt_marshallOut("coder.internal.isDomainError"), "name",
                323);
  emlrtAddField(*info, emlrt_marshallOut("function_handle"), "dominantType", 323);
  emlrtAddField(*info, emlrt_marshallOut(
    "[ILXE]/usr/local/MATLAB/R2015b/toolbox/eml/eml/+coder/+internal/isDomainError.m"),
                "resolved", 323);
  emlrtAddField(*info, b_emlrt_marshallOut(1419354984U), "fileTimeLo", 323);
  ...
  emlrtAddField(*info, emlrt_marshallOut(
    "[ILXE]/usr/local/MATLAB/R2015b/toolbox/eml/lib/matlab/elfun/sqrt.m"),
                "context", 324);
  emlrtAddField(*info, emlrt_marshallOut("coder.internal.error"), "name", 324);
  emlrtAddField(*info, emlrt_marshallOut("char"), "dominantType", 324);
  emlrtAddField(*info, emlrt_marshallOut(
    "[ILXE]/usr/local/MATLAB/R2015b/toolbox/eml/eml/+coder/+internal/error.m"),
                "resolved", 324);
  emlrtAddField(*info, b_emlrt_marshallOut(1419335426U), "fileTimeLo", 324);
  ...
  emlrtAddField(*info, emlrt_marshallOut(
    "[ILXE]/usr/local/MATLAB/R2015b/toolbox/eml/eml/+coder/+internal/+scalar/sqrt.m"),
                "resolved", 325);
  emlrtAddField(*info, b_emlrt_marshallOut(1415929514U), "fileTimeLo", 325);
  ...
  emlrtAddField(*info, emlrt_marshallOut(
    "[ILXE]/usr/local/MATLAB/R2015b/toolbox/eml/lib/matlab/elfun/sqrt.m"),
                "context", 326);
  emlrtAddField(*info, emlrt_marshallOut(
    "coder.internal.applyScalarFunctionInPlace"), "name", 326);
  emlrtAddField(*info, emlrt_marshallOut("function_handle"), "dominantType", 326);
  emlrtAddField(*info, emlrt_marshallOut(
    "[ILXE]/usr/local/MATLAB/R2015b/toolbox/eml/eml/+coder/+internal/applyScalarFunctionInPlace.m"),
                "resolved", 326);
  emlrtAddField(*info, b_emlrt_marshallOut(1422905800U), "fileTimeLo", 326);
  ...
  emlrtAddField(*info, emlrt_marshallOut(
    "[ILXE]/usr/local/MATLAB/R2015b/toolbox/eml/eml/+coder/+internal/+scalar/sqrt.m"),
                "resolved", 327);
  emlrtAddField(*info, b_emlrt_marshallOut(1415929514U), "fileTimeLo", 327);
  ...
  emlrtAddField(*info, emlrt_marshallOut(
    "[ILXE]/usr/local/MATLAB/R2015b/toolbox/eml/lib/matlab/ops/mrdivide.p"),
                "resolved", 328);
  emlrtAddField(*info, b_emlrt_marshallOut(1431720334U), "fileTimeLo", 328);
  emlrtAddField(*info, b_emlrt_marshallOut(0U), "fileTimeHi", 328);
  emlrtAddField(*info, b_emlrt_marshallOut(1415929540U), "mFileTimeLo", 328);
  ...
  emlrtAddField(*info, emlrt_marshallOut(
    "[ILXE]/usr/local/MATLAB/R2015b/toolbox/eml/lib/matlab/ops/eml_mtimes_helper.m"),
                "resolved", 329);
  emlrtAddField(*info, b_emlrt_marshallOut(1415929538U), "fileTimeLo", 329);
  ...
  emlrtAddField(*info, emlrt_marshallOut(
    "[ILXE]/usr/local/MATLAB/R2015b/toolbox/eml/eml/+coder/+internal/isBuiltInNumeric.m"),
                "resolved", 330);
  emlrtAddField(*info, b_emlrt_marshallOut(1395949856U), "fileTimeLo", 330);
  ...
  emlrtAddField(*info, emlrt_marshallOut(
    "[IXC]/usr/local/MATLAB/R2015b/toolbox/comm/comm/+comm/RaisedCosineReceiveFilter.m"),
                "context", 331);
  emlrtAddField(*info, emlrt_marshallOut("dspcodegen.FIRDecimator"), "name", 331);
  emlrtAddField(*info, emlrt_marshallOut("int32"), "dominantType", 331);
  emlrtAddField(*info, emlrt_marshallOut(
    "[IXC]/usr/local/MATLAB/R2015b/toolbox/dsp/dsp/compiled/+dspcodegen/FIRDecimator.p"),
                "resolved", 331);
  emlrtAddField(*info, b_emlrt_marshallOut(1431725912U), "fileTimeLo", 331);
  ...
  emlrtAddField(*info, emlrt_marshallOut(
    "[IXE]/usr/local/MATLAB/R2015b/toolbox/matlab/system/+matlab/+system/isSystemObject.p"),
                "resolved", 332);
  emlrtAddField(*info, b_emlrt_marshallOut(1431666890U), "fileTimeLo", 332);
  ...
  emlrtAddField(*info, emlrt_marshallOut(
    "[IXC]/usr/local/MATLAB/R2015b/toolbox/shared/system/coder/+matlab/+system/+coder/SystemProp.p"),
                "context", 333);
  emlrtAddField(*info, emlrt_marshallOut("matlab.system.setProp"), "name", 333);
  emlrtAddField(*info, emlrt_marshallOut("dspcodegen.FIRDecimator"),
                "dominantType", 333);
  emlrtAddField(*info, emlrt_marshallOut(
    "[IXE]/usr/local/MATLAB/R2015b/toolbox/matlab/system/+matlab/+system/setProp.p"),
                "resolved", 333);
  emlrtAddField(*info, b_emlrt_marshallOut(1431666890U), "fileTimeLo", 333);
  ...
  emlrtAddField(*info, emlrt_marshallOut(
    "[IXC]/usr/local/MATLAB/R2015b/toolbox/dsp/dsp/compiled/+dspcodegen/FIRDecimator.p"),
                "context", 334);
  emlrtAddField(*info, emlrt_marshallOut("release"), "name", 334);
  emlrtAddField(*info, emlrt_marshallOut("dsp.FIRDecimator"), "dominantType",
                334);
  emlrtAddField(*info, emlrt_marshallOut(
    "[ILXE]/usr/local/MATLAB/R2015b/toolbox/eml/lib/scomp/release.m"),
                "resolved", 334);
  emlrtAddField(*info, b_emlrt_marshallOut(1391553530U), "fileTimeLo", 334);
  ...
  emlrtAddField(*info, emlrt_marshallOut(
    "[ILXE]/usr/local/MATLAB/R2015b/toolbox/eml/lib/scomp/release.m"), "context",
                335);
  emlrtAddField(*info, emlrt_marshallOut("checkSystemObjectInput"), "name", 335);
  emlrtAddField(*info, emlrt_marshallOut("dsp.FIRDecimator"), "dominantType",
                335);
  emlrtAddField(*info, emlrt_marshallOut(
    "[ILXE]/usr/local/MATLAB/R2015b/toolbox/eml/lib/scomp/checkSystemObjectInput.m"),
                "resolved", 335);
  emlrtAddField(*info, b_emlrt_marshallOut(1415929546U), "fileTimeLo", 335);
  ...
  emlrtAddField(*info, emlrt_marshallOut(
    "[IXC]/usr/local/MATLAB/R2015b/toolbox/comm/comm/+comm/+internal/CoarseFrequencyEstimatorBase.m"),
                "context", 336);
  emlrtAddField(*info, emlrt_marshallOut("release"), "name", 336);
  emlrtAddField(*info, emlrt_marshallOut("dsp.FFT"), "dominantType", 336);
  emlrtAddField(*info, emlrt_marshallOut(
    "[ILXE]/usr/local/MATLAB/R2015b/toolbox/eml/lib/scomp/release.m"),
                "resolved", 336);
  emlrtAddField(*info, b_emlrt_marshallOut(1391553530U), "fileTimeLo", 336);
  ...
  emlrtAddField(*info, emlrt_marshallOut(
    "[ILXE]/usr/local/MATLAB/R2015b/toolbox/eml/lib/scomp/release.m"), "context",
                337);
  emlrtAddField(*info, emlrt_marshallOut("checkSystemObjectInput"), "name", 337);
  emlrtAddField(*info, emlrt_marshallOut("dsp.FFT"), "dominantType", 337);
  emlrtAddField(*info, emlrt_marshallOut(
    "[ILXE]/usr/local/MATLAB/R2015b/toolbox/eml/lib/scomp/checkSystemObjectInput.m"),
                "resolved", 337);
  emlrtAddField(*info, b_emlrt_marshallOut(1415929546U), "fileTimeLo", 337);
  ...
  emlrtAddField(*info, emlrt_marshallOut(
    "[IXC]/usr/local/MATLAB/R2015b/toolbox/comm/comm/compiled/+commcodegen/PhaseFrequencyOffset.p"),
                "context", 338);
  emlrtAddField(*info, emlrt_marshallOut("release"), "name", 338);
  emlrtAddField(*info, emlrt_marshallOut("comm.PhaseFrequencyOffset"),
                "dominantType", 338);
  emlrtAddField(*info, emlrt_marshallOut(
    "[ILXE]/usr/local/MATLAB/R2015b/toolbox/eml/lib/scomp/release.m"),
                "resolved", 338);
  emlrtAddField(*info, b_emlrt_marshallOut(1391553530U), "fileTimeLo", 338);
  ...
  emlrtAddField(*info, emlrt_marshallOut(
    "[ILXE]/usr/local/MATLAB/R2015b/toolbox/eml/lib/scomp/release.m"), "context",
                339);
  emlrtAddField(*info, emlrt_marshallOut("checkSystemObjectInput"), "name", 339);
  emlrtAddField(*info, emlrt_marshallOut("comm.PhaseFrequencyOffset"),
                "dominantType", 339);
  emlrtAddField(*info, emlrt_marshallOut(
    "[ILXE]/usr/local/MATLAB/R2015b/toolbox/eml/lib/scomp/checkSystemObjectInput.m"),
                "resolved", 339);
  emlrtAddField(*info, b_emlrt_marshallOut(1415929546U), "fileTimeLo", 339);
...
static void info_helper(const mxArray **info)
{
  ...
  emlrtAddField(*info, emlrt_marshallOut(
    "[IXC]/usr/local/MATLAB/R2015b/toolbox/comm/comm/compiled/+comm/+internal/Helper.p"),
                "context", 4);
  emlrtAddField(*info, emlrt_marshallOut("matlab.system.coder.System"), "name",
                4);
  ...
  emlrtAddField(*info, emlrt_marshallOut(
    "[IXC]/usr/local/MATLAB/R2015b/toolbox/comm/comm/+comm/AGC.m"), "context", 5);
  emlrtAddField(*info, emlrt_marshallOut("comm.internal.Helper"), "name", 5);
  emlrtAddField(*info, emlrt_marshallOut("unknown"), "dominantType", 5);
  emlrtAddField(*info, emlrt_marshallOut(
    "[IXC]/usr/local/MATLAB/R2015b/toolbox/comm/comm/compiled/+comm/+internal/Helper.p"),
                "resolved", 5);
  emlrtAddField(*info, b_emlrt_marshallOut(1431744710U), "fileTimeLo", 5);
  ...
  emlrtAddField(*info, emlrt_marshallOut(
    "[IXC]/usr/local/MATLAB/R2015b/toolbox/shared/system/coder/+matlab/+system/+mixin/+coder/Propagates.p"),
                "context", 6);
  emlrtAddField(*info, emlrt_marshallOut("coder.internal.matlabCodegenHandle"),
                "name", 6);
  ...
  emlrtAddField(*info, emlrt_marshallOut(
    "[ILXC]/usr/local/MATLAB/R2015b/toolbox/coder/coder/+coder/+internal/matlabCodegenHandle.p"),
                "resolved", 6);
  emlrtAddField(*info, b_emlrt_marshallOut(1431720362U), "fileTimeLo", 6);
  ...
  emlrtAddField(*info, emlrt_marshallOut(
    "[IXC]/usr/local/MATLAB/R2015b/toolbox/comm/comm/+comm/AGC.m"), "context", 7);
  ...
  emlrtAddField(*info, emlrt_marshallOut(
    "[IXC]/usr/local/MATLAB/R2015b/toolbox/shared/system/coder/+matlab/+system/+mixin/+coder/Propagates.p"),
                "resolved", 7);
  emlrtAddField(*info, b_emlrt_marshallOut(1431715900U), "fileTimeLo", 7);
  ...
  emlrtAddField(*info, emlrt_marshallOut(
    "[IXC]/usr/local/MATLAB/R2015b/toolbox/matlab/system/+matlab/+system/+mixin/CustomIcon.p"),
                "context", 8);
  emlrtAddField(*info, emlrt_marshallOut("coder.internal.matlabCodegenHandle"),
                "name", 8);
  ...
  emlrtAddField(*info, emlrt_marshallOut(
    "[ILXC]/usr/local/MATLAB/R2015b/toolbox/coder/coder/+coder/+internal/matlabCodegenHandle.p"),
                "resolved", 8);
  emlrtAddField(*info, b_emlrt_marshallOut(1431720362U), "fileTimeLo", 8);
  ...
  emlrtAddField(*info, emlrt_marshallOut(
    "[IXC]/usr/local/MATLAB/R2015b/toolbox/comm/comm/+comm/AGC.m"), "context", 9);
  ...
  emlrtAddField(*info, emlrt_marshallOut(
    "[IXC]/usr/local/MATLAB/R2015b/toolbox/matlab/system/+matlab/+system/+mixin/CustomIcon.p"),
                "resolved", 9);
  emlrtAddField(*info, b_emlrt_marshallOut(1431666890U), "fileTimeLo", 9);
  ...
  emlrtAddField(*info, emlrt_marshallOut(
    "[E]/usr/local/MATLAB/V40_demo/drx/rffe_timing/rffe_100.m"), "context", 10);
  emlrtAddField(*info, emlrt_marshallOut("comm.AGC"), "name", 10);
  emlrtAddField(*info, emlrt_marshallOut("char"), "dominantType", 10);
  emlrtAddField(*info, emlrt_marshallOut(
    "[IXC]/usr/local/MATLAB/R2015b/toolbox/comm/comm/+comm/AGC.m"), "resolved",
                10);
  emlrtAddField(*info, b_emlrt_marshallOut(1430148068U), "fileTimeLo", 10);
  ...
  emlrtAddField(*info, emlrt_marshallOut(
    "[IXC]/usr/local/MATLAB/R2015b/toolbox/shared/system/coder/+matlab/+system/+coder/SystemProp.p"),
                "resolved", 11);
  emlrtAddField(*info, b_emlrt_marshallOut(1431715898U), "fileTimeLo", 11);
  ...
  emlrtAddField(*info, emlrt_marshallOut(
    "[IXC]/usr/local/MATLAB/R2015b/toolbox/shared/system/coder/+matlab/+system/+coder/SystemCore.p"),
                "resolved", 12);
  emlrtAddField(*info, b_emlrt_marshallOut(1431715898U), "fileTimeLo", 12);
  ...
  emlrtAddField(*info, emlrt_marshallOut("comm.AGC"), "dominantType", 15);
  emlrtAddField(*info, emlrt_marshallOut(
    "[IXE]/usr/local/MATLAB/R2015b/toolbox/matlab/system/+matlab/+system/pvParse.p"),
                "resolved", 15);
  ...
  emlrtAddField(*info, emlrt_marshallOut(
    "[IXC]/usr/local/MATLAB/R2015b/toolbox/comm/comm/+comm/AGC.m"), "context",
                32);
  emlrtAddField(*info, emlrt_marshallOut("validateattributes"), "name", 32);
  emlrtAddField(*info, emlrt_marshallOut("cell"), "dominantType", 32);
  emlrtAddField(*info, emlrt_marshallOut(
    "[ILXE]/usr/local/MATLAB/R2015b/toolbox/eml/lib/matlab/lang/validateattributes.m"),
                "resolved", 32);
  emlrtAddField(*info, b_emlrt_marshallOut(1421766848U), "fileTimeLo", 32);
  ...
  emlrtAddField(*info, emlrt_marshallOut(
    "[ILXE]/usr/local/MATLAB/R2015b/toolbox/eml/lib/matlab/lang/validateattributes.m"),
                "context", 33);
  emlrtAddField(*info, emlrt_marshallOut("char"), "name", 33);
  emlrtAddField(*info, emlrt_marshallOut("char"), "dominantType", 33);
  emlrtAddField(*info, emlrt_marshallOut(
    "[ILXE]/usr/local/MATLAB/R2015b/toolbox/eml/lib/matlab/strfun/char.m"),
                "resolved", 33);
  emlrtAddField(*info, b_emlrt_marshallOut(1415929544U), "fileTimeLo", 33);
  ...
  emlrtAddField(*info, emlrt_marshallOut(
    "[ILXE]/usr/local/MATLAB/R2015b/toolbox/eml/lib/matlab/lang/validateattributes.m!notisnan"),
                "context", 34);
  ...
  emlrtAddField(*info, emlrt_marshallOut(
    "[ILXE]/usr/local/MATLAB/R2015b/toolbox/eml/lib/matlab/lang/validateattributes.m!all"),
                "context", 37);
  ...
  emlrtAddField(*info, emlrt_marshallOut(
    "[IXC]/usr/local/MATLAB/R2015b/toolbox/shared/system/coder/+matlab/+system/+coder/System.p"),
                "resolved", 42);
  emlrtAddField(*info, b_emlrt_marshallOut(1431715898U), "fileTimeLo", 42);
  ...
  emlrtAddField(*info, emlrt_marshallOut(
    "[ILXC]/usr/local/MATLAB/R2015b/toolbox/coder/coder/+coder/+internal/matlabCodegenHandle.p"),
                "resolved", 43);
  emlrtAddField(*info, b_emlrt_marshallOut(1431720362U), "fileTimeLo", 43);
  ...
  emlrtAddField(*info, emlrt_marshallOut(
    "[IXC]/usr/local/MATLAB/R2015b/toolbox/shared/system/coder/+matlab/+system/+mixin/+coder/Nondirect.p"),
                "resolved", 44);
  emlrtAddField(*info, b_emlrt_marshallOut(1431715898U), "fileTimeLo", 44);
  ...
  emlrtAddField(*info, emlrt_marshallOut(
    "[E]/usr/local/MATLAB/V40_demo/drx/rffe_timing/rffe_100.m"), "context", 45);
  emlrtAddField(*info, emlrt_marshallOut("dspcodegen.FIRDecimator"), "name", 45);
  emlrtAddField(*info, emlrt_marshallOut("int32"), "dominantType", 45);
  emlrtAddField(*info, emlrt_marshallOut(
    "[IXC]/usr/local/MATLAB/R2015b/toolbox/dsp/dsp/compiled/+dspcodegen/FIRDecimator.p"),
                "resolved", 45);
  emlrtAddField(*info, b_emlrt_marshallOut(1431725912U), "fileTimeLo", 45);
  ...
  emlrtAddField(*info, emlrt_marshallOut(
    "[ILXE]/usr/local/MATLAB/R2015b/toolbox/eml/lib/scomp/createsystemobjectv2.m"),
                "resolved", 46);
  emlrtAddField(*info, b_emlrt_marshallOut(1416015006U), "fileTimeLo", 46);
  ...
  emlrtAddField(*info, emlrt_marshallOut(
    "[ILXE]/usr/local/MATLAB/R2015b/toolbox/eml/eml/+coder/+internal/length.m"),
                "resolved", 47);
  emlrtAddField(*info, b_emlrt_marshallOut(1429650858U), "fileTimeLo", 47);
  ...
  emlrtAddField(*info, emlrt_marshallOut(
    "[IXC]/usr/local/MATLAB/R2015b/toolbox/shared/system/coder/+matlab/+system/+coder/System.p"),
                "resolved", 49);
  emlrtAddField(*info, b_emlrt_marshallOut(1431715898U), "fileTimeLo", 49);
  ...
  emlrtAddField(*info, emlrt_marshallOut(
    "[IXC]/usr/local/MATLAB/R2015b/toolbox/shared/system/coder/+matlab/+system/+coder/SystemProp.p"),
                "context", 50);
  emlrtAddField(*info, emlrt_marshallOut("matlab.system.pvParse"), "name", 50);
  emlrtAddField(*info, emlrt_marshallOut("dspcodegen.FIRDecimator"),
                "dominantType", 50);
  emlrtAddField(*info, emlrt_marshallOut(
    "[IXE]/usr/local/MATLAB/R2015b/toolbox/matlab/system/+matlab/+system/pvParse.p"),
                "resolved", 50);
  emlrtAddField(*info, b_emlrt_marshallOut(1431666890U), "fileTimeLo", 50);
  ...
  emlrtAddField(*info, emlrt_marshallOut(
    "[IXC]/usr/local/MATLAB/R2015b/toolbox/shared/system/coder/+matlab/+system/+coder/SystemProp.p"),
                "resolved", 51);
  emlrtAddField(*info, b_emlrt_marshallOut(1431715898U), "fileTimeLo", 51);
  ...
  emlrtAddField(*info, emlrt_marshallOut(
    "[IXC]/usr/local/MATLAB/R2015b/toolbox/dsp/dsp/compiled/+dspcodegen/FIRDecimator.p"),
                "context", 52);
  emlrtAddField(*info, emlrt_marshallOut("dspcodegen.FIRDecimator"), "name", 52);
  emlrtAddField(*info, emlrt_marshallOut(""), "dominantType", 52);
  emlrtAddField(*info, emlrt_marshallOut(
    "[IXC]/usr/local/MATLAB/R2015b/toolbox/dsp/dsp/compiled/+dspcodegen/FIRDecimator.p"),
                "resolved", 52);
  emlrtAddField(*info, b_emlrt_marshallOut(1431725912U), "fileTimeLo", 52);
  ...
  emlrtAddField(*info, emlrt_marshallOut(
    "[IXC]/usr/local/MATLAB/R2015b/toolbox/dsp/dsp/compiled/+dspcodegen/FIRDecimator.p"),
                "context", 53);
  emlrtAddField(*info, emlrt_marshallOut("get_impl"), "name", 53);
  emlrtAddField(*info, emlrt_marshallOut("dsp.FIRDecimator"), "dominantType", 53);
  emlrtAddField(*info, emlrt_marshallOut(
    "[ILXE]/usr/local/MATLAB/R2015b/toolbox/eml/lib/fixedpoint/get_impl.m"),
                "resolved", 53);
  emlrtAddField(*info, b_emlrt_marshallOut(1415929522U), "fileTimeLo", 53);
  ...
  emlrtAddField(*info, emlrt_marshallOut(
    "[ILXE]/usr/local/MATLAB/R2015b/toolbox/eml/lib/fixedpoint/get_impl.m"),
                "context", 54);
  emlrtAddField(*info, emlrt_marshallOut("coder_sysobj_get"), "name", 54);
  ...
  emlrtAddField(*info, emlrt_marshallOut(
    "[IXE]/usr/local/MATLAB/R2015b/toolbox/shared/system/coder/coder_sysobj_get.m"),
                "resolved", 54);
  emlrtAddField(*info, b_emlrt_marshallOut(1365756022U), "fileTimeLo", 54);
  ...
  emlrtAddField(*info, emlrt_marshallOut(
    "[E]/usr/local/MATLAB/V40_demo/drx/rffe_timing/rffe_100.m"), "context", 55);
  emlrtAddField(*info, emlrt_marshallOut("mrdivide"), "name", 55);
  emlrtAddField(*info, emlrt_marshallOut("double"), "dominantType", 55);
  emlrtAddField(*info, emlrt_marshallOut(
    "[ILXE]/usr/local/MATLAB/R2015b/toolbox/eml/lib/matlab/ops/mrdivide.p"),
                "resolved", 55);
  emlrtAddField(*info, b_emlrt_marshallOut(1431720334U), "fileTimeLo", 55);
  ...
  emlrtAddField(*info, emlrt_marshallOut(
    "[ILXE]/usr/local/MATLAB/R2015b/toolbox/eml/lib/matlab/ops/rdivide.m"),
                "resolved", 56);
  emlrtAddField(*info, b_emlrt_marshallOut(1415929540U), "fileTimeLo", 56);
  ...
  emlrtAddField(*info, emlrt_marshallOut(
    "[ILXE]/usr/local/MATLAB/R2015b/toolbox/eml/eml/+coder/+internal/scalexpCompatible.m"),
                "resolved", 58);
  emlrtAddField(*info, b_emlrt_marshallOut(1415929516U), "fileTimeLo", 58);
  ...
  emlrtAddField(*info, emlrt_marshallOut(
    "[IXC]/usr/local/MATLAB/R2015b/toolbox/shared/system/coder/+matlab/+system/+coder/System.p"),
                "resolved", 60);
  emlrtAddField(*info, b_emlrt_marshallOut(1431715898U), "fileTimeLo", 60);
  ...
  emlrtAddField(*info, emlrt_marshallOut("matlab.system.mixin.CustomIcon"),
                "name", 61);
  emlrtAddField(*info, emlrt_marshallOut("unknown"), "dominantType", 61);
  emlrtAddField(*info, emlrt_marshallOut(
    "[IXC]/usr/local/MATLAB/R2015b/toolbox/matlab/system/+matlab/+system/+mixin/CustomIcon.p"),
                "resolved", 61);
  emlrtAddField(*info, b_emlrt_marshallOut(1431666890U), "fileTimeLo", 61);
  ...
  emlrtAddField(*info, emlrt_marshallOut(
    "[IXC]/usr/local/MATLAB/R2015b/toolbox/comm/comm/+comm/PSKCoarseFrequencyEstimator.m"),
                "context", 62);
  emlrtAddField(*info, emlrt_marshallOut(
    "comm.internal.CoarseFrequencyEstimatorBase"), "name", 62);
  emlrtAddField(*info, emlrt_marshallOut("unknown"), "dominantType", 62);
  emlrtAddField(*info, emlrt_marshallOut(
    "[IXC]/usr/local/MATLAB/R2015b/toolbox/comm/comm/+comm/+internal/CoarseFrequencyEstimatorBase.m"),
                "resolved", 62);
  emlrtAddField(*info, b_emlrt_marshallOut(1413401734U), "fileTimeLo", 62);
  ...
  emlrtAddField(*info, emlrt_marshallOut(
    "[E]/usr/local/MATLAB/V40_demo/drx/rffe_timing/rffe_100.m"), "context", 63);
  emlrtAddField(*info, emlrt_marshallOut("comm.PSKCoarseFrequencyEstimator"),
                "name", 63);
  ...
  emlrtAddField(*info, emlrt_marshallOut(
    "[IXC]/usr/local/MATLAB/R2015b/toolbox/comm/comm/+comm/PSKCoarseFrequencyEstimator.m"),
                "resolved", 63);
  emlrtAddField(*info, b_emlrt_marshallOut(1413401938U), "fileTimeLo", 63);
...
mxArray *emlrtMexFcnProperties(void)
{
  ...
  emlrtSetField(xEntryPoints, 0, "Name", mxCreateString("rffe_100"));
...
const mxArray *emlrtMexFcnResolvedFunctionsInfo(void)
{
  ...
  emlrtAssign(&nameCaptureInfo, emlrtCreateStructMatrix(340, 1, 0, NULL));
...
/* End of code generation (_coder_rffe_100_info.c) */
