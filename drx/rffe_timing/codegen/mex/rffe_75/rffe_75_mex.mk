...
MAKEFILE = rffe_75_mex.mk

include rffe_75_mex.mki
...
SRC_FILES =  \
	...
	_coder_rffe_75_mex.c

MEX_FILE_NAME_WO_EXT = rffe_75_mex
...
SYS_INCLUDE += -I "$(START_DIR)/codegen/mex/rffe_75"
...
%.$(OBJEXT) : $(START_DIR)/codegen/mex/rffe_75/%.c
	$(CC) $(CCFLAGS) "$<"
...
%.$(OBJEXT) : $(START_DIR)/codegen/mex/rffe_75/%.cu
	$(CC) $(CCFLAGS) "$<"
...
%.$(OBJEXT) : $(START_DIR)/codegen/mex/rffe_75/%.cpp
	$(CXX) $(CPPFLAGS) "$<"
