 ...
 *
 * Code generation for function '_coder_rffe_75_mex'
 *
 */
...
static void rffe_75_mexFunction(int32_T nlhs, mxArray *plhs[1], int32_T nrhs,
                 ...
                 *prhs[])
{
  ...
  if (setjmp(emlrtJBEnviron) == 0) {
    ...
    rffe_75_mexFunction(nlhs, plhs, nrhs, prhs);
...
/* End of code generation (_coder_rffe_75_mex.c) */
