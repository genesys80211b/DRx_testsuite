...
MAKEFILE = rffe_50_mex.mk

include rffe_50_mex.mki
...
SRC_FILES =  \
	...
	_coder_rffe_50_api.c \
	_coder_rffe_50_mex.c

MEX_FILE_NAME_WO_EXT = rffe_50_mex
...
SYS_INCLUDE += -I "$(START_DIR)/codegen/mex/rffe_50"
...
%.$(OBJEXT) : $(START_DIR)/codegen/mex/rffe_50/%.c
	$(CC) $(CCFLAGS) "$<"
...
%.$(OBJEXT) : $(START_DIR)/codegen/mex/rffe_50/%.cu
	$(CC) $(CCFLAGS) "$<"
...
%.$(OBJEXT) : $(START_DIR)/codegen/mex/rffe_50/%.cpp
	$(CXX) $(CPPFLAGS) "$<"
