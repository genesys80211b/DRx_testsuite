  ...
  c_comm_PSKCoarseFrequencyEstima *obj, const creal_T x[64])
{
  ...
  creal_T varargin_1[256];
  real_T absFFTSig[256];
  int32_T dim;
  int32_T vlend2;
  int32_T vstride;
  int32_T midoffset;
  ...
  for (ixstart = 0; ixstart < 64; ixstart++) {
    b_obj->pRaisedSignalBuffer[ixstart + 192] = raisedSignal[ixstart];
  }
  ...
  c_MWDSPCG_R2BRScramble_OutPlace((creal_T *)&varargout_1[0U], (creal_T *)
    &varargin_1[0U], 1, 256);
  MWDSPCG_R2DIT_TBLS_Z((creal_T *)&varargout_1[0U], 1, 256, 256, 0, (real_T *)
  ...
  return 35.511363636363633 * (((real_T)itmp - 128.0) - 1.0) / 2.0;
}
