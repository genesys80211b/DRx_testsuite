...
static const mxArray *emlrt_marshallOut(const emlrtStack *sp, const char_T u[6])
{
  ...
  const mxArray *m7;
  y = NULL;
  m7 = emlrtCreateCharArray(2, iv12);
  emlrtInitCharArrayR2013a(sp, 6, m7, &u[0]);
  emlrtAssign(&y, m7);
  return y;
}
                 ...
                 errStr_size[2])
{
  ...
  if (!isSetupsdruCalled) {
    ...
    setupsdru(&b_st, sdruroot(&b_st, &c_emlrtMCI), emlrt_marshallOut(&b_st, cv16),
              &d_emlrtMCI);
