 ...
 *
 * _coder_rffe_test_info.c
 *
 * Code generation for function '_coder_rffe_test_info'
 *
 */
...
#include "rffe_test.h"
#include "_coder_rffe_test_info.h"
...
static void c_info_helper(const mxArray **info)
{
  ...
  emlrtAddField(*info, emlrt_marshallOut(
    "[E]/usr/local/MATLAB/V40_demo/drx/rffe_test.m"), "context", 143);
  ...
  emlrtAddField(*info, emlrt_marshallOut(
    "[E]/usr/local/MATLAB/V40_demo/drx/rffe_test.m"), "context", 152);
...
static void info_helper(const mxArray **info)
{
  ...
  emlrtAddField(*info, emlrt_marshallOut(
    "[E]/usr/local/MATLAB/V40_demo/drx/rffe_test.m"), "context", 10);
  ...
  emlrtAddField(*info, emlrt_marshallOut(
    "[E]/usr/local/MATLAB/V40_demo/drx/rffe_test.m"), "context", 45);
  ...
  emlrtAddField(*info, emlrt_marshallOut(
    "[E]/usr/local/MATLAB/V40_demo/drx/rffe_test.m"), "context", 55);
  ...
  emlrtAddField(*info, emlrt_marshallOut(
    "[E]/usr/local/MATLAB/V40_demo/drx/rffe_test.m"), "context", 63);
  emlrtAddField(*info, emlrt_marshallOut("comm.PSKCoarseFrequencyEstimator"),
                "name", 63);
...
mxArray *emlrtMexFcnProperties(void)
{
  ...
  emlrtSetField(xEntryPoints, 0, "Name", mxCreateString("rffe_test"));
...
/* End of code generation (_coder_rffe_test_info.c) */
