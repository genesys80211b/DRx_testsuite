...
#include "rffe_test.h"
#include "_coder_rffe_test_api.h"
...
void rffe_test_api(const mxArray * const prhs[4], const mxArray *plhs[1])
{
  creal_T df[1408];
  boolean_T ft;
  real_T cas;
  ...
  rffe_test(&st, df, ft, cas, cau, dfr);

  /* Marshall function outputs */
  plhs[0] = c_emlrt_marshallOut(&st, dfr);
}

/* End of code generation (_coder_rffe_test_api.c) */
