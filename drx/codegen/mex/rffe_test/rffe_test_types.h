...
#ifndef __RFFE_TEST_TYPES_H__
#define __RFFE_TEST_TYPES_H__
...
typedef struct {
  ...
  dsp_FFT_3 pFFT;
  creal_T pRaisedSignalBuffer[512];
...
/* End of code generation (rffe_test_types.h) */
