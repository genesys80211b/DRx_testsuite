...
static emlrtRSInfo emlrtRSI = { 33, "rffe_test",
  "/usr/local/MATLAB/V40_demo/drx/rffe_test.m" };

static emlrtRSInfo b_emlrtRSI = { 36, "rffe_test",
  "/usr/local/MATLAB/V40_demo/drx/rffe_test.m" };

static emlrtRSInfo c_emlrtRSI = { 39, "rffe_test",
  "/usr/local/MATLAB/V40_demo/drx/rffe_test.m" };

static emlrtRSInfo d_emlrtRSI = { 43, "rffe_test",
  "/usr/local/MATLAB/V40_demo/drx/rffe_test.m" };

static emlrtRSInfo e_emlrtRSI = { 47, "rffe_test",
  "/usr/local/MATLAB/V40_demo/drx/rffe_test.m" };

static emlrtRSInfo f_emlrtRSI = { 59, "rffe_test",
  "/usr/local/MATLAB/V40_demo/drx/rffe_test.m" };

static emlrtRSInfo g_emlrtRSI = { 60, "rffe_test",
  "/usr/local/MATLAB/V40_demo/drx/rffe_test.m" };

static emlrtRSInfo h_emlrtRSI = { 61, "rffe_test",
  "/usr/local/MATLAB/V40_demo/drx/rffe_test.m" };

static emlrtRSInfo i_emlrtRSI = { 62, "rffe_test",
  "/usr/local/MATLAB/V40_demo/drx/rffe_test.m" };

static emlrtRSInfo j_emlrtRSI = { 63, "rffe_test",
  "/usr/local/MATLAB/V40_demo/drx/rffe_test.m" };

static emlrtRSInfo k_emlrtRSI = { 67, "rffe_test",
  "/usr/local/MATLAB/V40_demo/drx/rffe_test.m" };

static emlrtRSInfo l_emlrtRSI = { 69, "rffe_test",
  "/usr/local/MATLAB/V40_demo/drx/rffe_test.m" };

static emlrtRSInfo m_emlrtRSI = { 71, "rffe_test",
  "/usr/local/MATLAB/V40_demo/drx/rffe_test.m" };

static emlrtRSInfo n_emlrtRSI = { 73, "rffe_test",
  "/usr/local/MATLAB/V40_demo/drx/rffe_test.m" };

static emlrtRSInfo o_emlrtRSI = { 75, "rffe_test",
  "/usr/local/MATLAB/V40_demo/drx/rffe_test.m" };
...
/* End of code generation (rffe_test.c) */
