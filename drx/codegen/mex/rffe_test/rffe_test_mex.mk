...
MAKEFILE = rffe_test_mex.mk

include rffe_test_mex.mki
...
SRC_FILES =  \
	...
	_coder_rffe_test_api.c \
	_coder_rffe_test_mex.c

MEX_FILE_NAME_WO_EXT = rffe_test_mex
...
SYS_INCLUDE += -I "$(START_DIR)/codegen/mex/rffe_test"
...
%.$(OBJEXT) : $(START_DIR)/codegen/mex/rffe_test/%.c
	$(CC) $(CCFLAGS) "$<"
...
%.$(OBJEXT) : $(START_DIR)/codegen/mex/rffe_test/%.cu
	$(CC) $(CCFLAGS) "$<"
...
%.$(OBJEXT) : $(START_DIR)/codegen/mex/rffe_test/%.cpp
	$(CXX) $(CPPFLAGS) "$<"
